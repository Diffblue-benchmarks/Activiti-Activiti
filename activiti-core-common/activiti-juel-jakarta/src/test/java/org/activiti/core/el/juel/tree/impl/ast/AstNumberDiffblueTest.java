...
class AstNumberDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test appendStructure(StringBuilder, Bindings); then StringBuilder(String) with 'Str' toString is 'Str1'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void AstNumber.appendStructure(StringBuilder, Bindings)"})
  void testAppendStructure_thenStringBuilderWithStrToStringIsStr1() {
    // Arrange
    Integer value = Integer.valueOf(1);
    AstNumber astNumber = new AstNumber(value);
