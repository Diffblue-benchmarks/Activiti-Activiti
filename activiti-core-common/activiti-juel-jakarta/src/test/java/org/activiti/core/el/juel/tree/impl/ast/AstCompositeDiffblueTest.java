...
class AstCompositeDiffblueTest {
  ...
  void testAppendStructure() {
    ...
    // Assert
    assertEquals(
        "Strnullnullnullnullnullnullnullnullnullnullnullnullnullnullnullnullnullnull",
        b.toString());
  }
  ...
  void testAppendStructure2() {
    ...
    // Assert
    assertEquals(
        "Strnullnullnullnullnullnullnullnullnullnullnullnullnullnullnullnullnull", b.toString());
  }
