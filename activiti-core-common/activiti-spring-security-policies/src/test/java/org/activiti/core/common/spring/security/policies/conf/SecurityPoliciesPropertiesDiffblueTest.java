...
class SecurityPoliciesPropertiesDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SecurityPoliciesProperties.<init>()",
    "List SecurityPoliciesProperties.getPolicies()",
  ...
  void testGettersAndSetters() {
    ...
    List<SecurityPolicy> actualPolicies = actualSecurityPoliciesProperties.getPolicies();

    // Assert
    assertEquals("*", actualSecurityPoliciesProperties.getWildcard());
