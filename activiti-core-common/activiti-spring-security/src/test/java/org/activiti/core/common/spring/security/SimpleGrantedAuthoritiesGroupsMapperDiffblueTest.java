...
class SimpleGrantedAuthoritiesGroupsMapperDiffblueTest {
  @Autowired private SimpleGrantedAuthoritiesGroupsMapper simpleGrantedAuthoritiesGroupsMapper;
   ...
   * </ul>
   *
   * <p>Method under test: {@link SimpleGrantedAuthoritiesGroupsMapper#getGroups(Collection)}
   */
  @Test
