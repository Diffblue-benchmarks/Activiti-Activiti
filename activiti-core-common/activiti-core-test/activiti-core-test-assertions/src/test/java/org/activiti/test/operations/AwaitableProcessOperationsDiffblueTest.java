...
class AwaitableProcessOperationsDiffblueTest {
   ...
   *
   * <p>Method under test: {@link AwaitableProcessOperations#start(StartProcessPayload)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ProcessInstanceAssertions AwaitableProcessOperations.start(StartProcessPayload)"
  })
  void testStart() {
    // Arrange
    ...
    when(processOperations.start(Mockito.<StartProcessPayload>any()))
        .thenReturn(new AwaitProcessInstanceAssertions(processInstanceAssertions));
    AwaitableProcessOperations awaitableProcessOperations =
        new AwaitableProcessOperations(processOperations, true);

    // Act
    ProcessInstanceAssertions actualStartResult =
        awaitableProcessOperations.start(new StartProcessPayload());
  ...
  void testStart2() {
    ...
    when(processOperations.start(Mockito.<StartProcessPayload>any()))
        .thenReturn(awaitProcessInstanceAssertions);
    AwaitableProcessOperations awaitableProcessOperations =
        new AwaitableProcessOperations(processOperations, false);
  ...
  void testStart3() {
    ...
    when(processOperations.start(Mockito.<StartProcessPayload>any()))
        .thenReturn(new AwaitProcessInstanceAssertions(processInstanceAssertions));
    AwaitableProcessOperations processOperations2 =
        new AwaitableProcessOperations(processOperations, true);
    AwaitableProcessOperations awaitableProcessOperations =
        new AwaitableProcessOperations(processOperations2, true);
   ...
   *
   * <p>Method under test: {@link AwaitableProcessOperations#signal(SignalPayload)}
   */
  @Test
  ...
  void testSignal() {
    // Arrange
    ProcessOperations processOperations = mock(ProcessOperations.class);
    when(processOperations.signal(Mockito.<SignalPayload>any()))
   ...
   *
   * <ul>
   *   <li>Then return {@link AwaitSignalAssertions}.
   * </ul>
   *
   * <p>Method under test: {@link AwaitableProcessOperations#signal(SignalPayload)}
   */
  ...
  void testSignal_thenReturnAwaitSignalAssertions2() {
    ...
    AwaitableProcessOperations processOperations2 =
        new AwaitableProcessOperations(processOperations, true);
    AwaitableProcessOperations awaitableProcessOperations =
        new AwaitableProcessOperations(processOperations2, false);
