...
class ActivitiUserGroupManagerImplDiffblueTest {
   ...
   * ActivitiUserGroupManagerImpl#ActivitiUserGroupManagerImpl(UserDetailsService)}
   */
  @Test
  ...
  void testNewActivitiUserGroupManagerImpl() {
    // Arrange and Act
    ActivitiUserGroupManagerImpl actualActivitiUserGroupManagerImpl =
   ...
   * </ul>
   *
   * <p>Method under test: {@link ActivitiUserGroupManagerImpl#getUserGroups(String)}
   */
  @Test
  ...
  void testGetUserGroups_thenReturnEmpty() throws UsernameNotFoundException {
    ...
    // Act
    List<String> actualUserGroups =
        new ActivitiUserGroupManagerImpl(userDetailsService).getUserGroups("janedoe");
   ...
   * </ul>
   *
   * <p>Method under test: {@link ActivitiUserGroupManagerImpl#getUserRoles(String)}
   */
  @Test
  @DisplayName(
      "Test getUserRoles(String); given ArrayList() add SimpleGrantedAuthority(String) with 'Role'; then return Empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  ...
  void testGetUserRoles_givenArrayListAddSimpleGrantedAuthorityWithRole_thenReturnEmpty()
    ...
    // Act
    List<String> actualUserRoles =
        new ActivitiUserGroupManagerImpl(userDetailsService).getUserRoles("janedoe");
   ...
   * </ul>
   *
   * <p>Method under test: {@link ActivitiUserGroupManagerImpl#getGroups()}
   */
  @Test
   ...
   * </ul>
   *
   * <p>Method under test: {@link ActivitiUserGroupManagerImpl#getUsers()}
   */
  @Test
