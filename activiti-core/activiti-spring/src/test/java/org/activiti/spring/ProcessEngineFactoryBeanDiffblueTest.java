...
public class ProcessEngineFactoryBeanDiffblueTest {
  ...
  public void testGetObject_thenCallsGetCustomFunctionProviders() throws Exception {
    ...
    processEngineConfiguration.setTransactionManager(new DataSourceTransactionManager());
    ...
    verify(processEngineConfiguration).setTransactionManager(isA(PlatformTransactionManager.class));
  }
