...
public class SpringCallerRunsRejectedJobsHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SpringCallerRunsRejectedJobsHandler.jobRejected(AsyncExecutor, Job)"})
  public void testJobRejected_whenDeadLetterJobEntityImpl_thenDoesNotThrow() {
    // Arrange
    SpringCallerRunsRejectedJobsHandler springCallerRunsRejectedJobsHandler =
        new SpringCallerRunsRejectedJobsHandler();
    DefaultAsyncJobExecutor asyncExecutor = new DefaultAsyncJobExecutor();
    ...
    // Act and Assert
    springCallerRunsRejectedJobsHandler.jobRejected(asyncExecutor, new DeadLetterJobEntityImpl());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SpringCallerRunsRejectedJobsHandler.jobRejected(AsyncExecutor, Job)"})
  public void testJobRejected_whenJobEntityImpl_thenDoesNotThrow() {
    // Arrange
    SpringCallerRunsRejectedJobsHandler springCallerRunsRejectedJobsHandler =
        new SpringCallerRunsRejectedJobsHandler();
    DefaultAsyncJobExecutor asyncExecutor = new DefaultAsyncJobExecutor();
    ...
    // Act and Assert
    springCallerRunsRejectedJobsHandler.jobRejected(asyncExecutor, new JobEntityImpl());
  }
}
