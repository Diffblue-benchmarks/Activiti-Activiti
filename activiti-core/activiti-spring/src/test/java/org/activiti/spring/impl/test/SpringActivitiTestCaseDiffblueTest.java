...
public class SpringActivitiTestCaseDiffblueTest {
  ...
  public void testInitializeProcessEngine() throws BeansException {
    ...
    when(applicationContext.getBean(ProcessEngine.class)).thenReturn(processEngineImpl);

    FailOnNoProcessAutoDeploymentStrategyTest failOnNoProcessAutoDeploymentStrategyTest =
        new FailOnNoProcessAutoDeploymentStrategyTest();
    failOnNoProcessAutoDeploymentStrategyTest.setApplicationContext(applicationContext);
