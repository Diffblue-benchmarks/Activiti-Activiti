...
class SignalAndMessageDefinitionExportDiffblueTest {
   ...
   *   <li>Then calls {@link BpmnModel#getMessages()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * SignalAndMessageDefinitionExport#writeSignalsAndMessages(BpmnModel, XMLStreamWriter)}
  ...
  @Test
  @DisplayName(
      "Test writeSignalsAndMessages(BpmnModel, XMLStreamWriter); given ArrayList() add Process (default constructor); then calls getMessages()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SignalAndMessageDefinitionExport.writeSignalsAndMessages(BpmnModel, XMLStreamWriter)"
  })
  void testWriteSignalsAndMessages_givenArrayListAddProcess_thenCallsGetMessages()
      throws Exception {
    // Arrange
    ArrayList<Process> processList = new ArrayList<>();
  ...
  @Test
  @DisplayName(
      "Test writeSignalsAndMessages(BpmnModel, XMLStreamWriter); given ArrayList(); then calls getMessages()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SignalAndMessageDefinitionExport.writeSignalsAndMessages(BpmnModel, XMLStreamWriter)"
   ...
   * <ul>
   *   <li>Given {@code false}.
   *   <li>Then calls {@link BpmnModel#addSignal(Signal)}.
   * </ul>
   *
   * <p>Method under test: {@link
   * SignalAndMessageDefinitionExport#writeSignalsAndMessages(BpmnModel, XMLStreamWriter)}
  ...
  @Test
  @DisplayName(
      "Test writeSignalsAndMessages(BpmnModel, XMLStreamWriter); given 'false'; then calls addSignal(Signal)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SignalAndMessageDefinitionExport.writeSignalsAndMessages(BpmnModel, XMLStreamWriter)"
  ...
  void testWriteSignalsAndMessages_givenFalse_thenCallsAddSignal() throws Exception {
    ...
    verify(model).containsSignalId("Signal Ref");
    verify(model).getMessages();
    verify(model).getProcesses();
    verify(model).getSignals();
    verify(process).findFlowElementsOfType(isA(Class.class));
   ...
   * <ul>
   *   <li>Given {@code true}.
   *   <li>When {@link BpmnModel} {@link BpmnModel#containsSignalId(String)} return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link
   * SignalAndMessageDefinitionExport#writeSignalsAndMessages(BpmnModel, XMLStreamWriter)}
  ...
  @Test
  @DisplayName(
      "Test writeSignalsAndMessages(BpmnModel, XMLStreamWriter); given 'true'; when BpmnModel containsSignalId(String) return 'true'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SignalAndMessageDefinitionExport.writeSignalsAndMessages(BpmnModel, XMLStreamWriter)"
  })
  void testWriteSignalsAndMessages_givenTrue_whenBpmnModelContainsSignalIdReturnTrue()
      throws Exception {
    // Arrange
    SignalEventDefinition eventDefinition = mock(SignalEventDefinition.class);
    when(eventDefinition.getSignalRef()).thenReturn("Signal Ref");
