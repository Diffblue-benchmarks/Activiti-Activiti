...
class TextAnnotationXMLConverterDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test writeAdditionalChildElements(BaseElement, BpmnModel, XMLStreamWriter); given 'bpmn2'; then calls writeCharacters(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testWriteAdditionalChildElements_givenBpmn2_thenCallsWriteCharacters() throws Exception {
    ...
    // Assert
    verify(writer).writeCharacters(eq("bpmn2"));
