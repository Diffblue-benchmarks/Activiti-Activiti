...
class EndEventXMLConverterDiffblueTest {
   ...
   *   <li>{@link EndEventXMLConverter#writeAdditionalAttributes(BaseElement, BpmnModel,
   *       XMLStreamWriter)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void EndEventXMLConverter.<init>()",
    "Class EndEventXMLConverter.getBpmnElementType()",
  ...
  void testGettersAndSetters() throws Exception {
    ...
    actualEndEventXMLConverter.writeAdditionalAttributes(
        element, model, new IndentingXMLStreamWriter(null));
    Class<? extends BaseElement> actualBpmnElementType =
        actualEndEventXMLConverter.getBpmnElementType();
