...
class DataStoreExportDiffblueTest {
   ...
   */
  @Test
  void testWriteDataStores() throws Exception {
    // Arrange
   ...
   */
  @Test
  void testWriteDataStores2() throws Exception {
    // Arrange
    HashMap<String, DataStore> stringDataStoreMap = new HashMap<>();
    stringDataStoreMap.putIfAbsent("foo", new DataStore());
    BpmnModel model = mock(BpmnModel.class);
   ...
   */
  @Test
  void testWriteDataStores3() throws Exception {
    // Arrange
   ...
   */
  @Test
  void testWriteDataStores4() throws Exception {
    // Arrange
    DataStore dataStore = mock(DataStore.class);
    when(dataStore.getId()).thenReturn("42");
