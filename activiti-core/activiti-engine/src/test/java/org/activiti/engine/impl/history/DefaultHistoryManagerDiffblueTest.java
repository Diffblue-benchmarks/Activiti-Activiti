...
public class DefaultHistoryManagerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DefaultHistoryManager.recordActivityEnd(ExecutionEntity, String)"})
  public void testRecordActivityEnd_thenCallsGetCurrentFlowElement() {
    // Arrange
    DefaultHistoryManager defaultHistoryManager =
        new DefaultHistoryManager(new JtaProcessEngineConfiguration(), HistoryLevel.ACTIVITY);
  ...
  public void testFindActivityInstanceWithExecutionActivityIdCreateOnNotFoundEndTimeMustBeNull() {
    ...
    execution.setTenantId("Execution");
  ...
  /**
   * Test {@link DefaultHistoryManager#createIdentityLinkComment(String, String, String, String,
   * boolean, boolean)} with {@code taskId}, {@code userId}, {@code groupId}, {@code type}, {@code
   * create}, {@code forceNullUserId}.
   *
   * <p>Method under test: {@link DefaultHistoryManager#createIdentityLinkComment(String, String,
  ...
  public void testCreateIdentityLinkCommentWithTaskIdUserIdGroupIdTypeCreateForceNullUserId() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());

    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    processEngineConfiguration.setClock(new DefaultClockImpl());
    processEngineConfiguration.setCommentEntityManager(commentEntityManager);

    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createIdentityLinkComment("42", "42", "42", "Type", true, true);

    // Assert
    verify(commentEntityManager).create();
    verify(commentEntityManager).insert(isA(CommentEntity.class));
  }
   ...
   *
   * <ul>
   *   <li>Then calls {@link CommentEntityManagerImpl#create()}.
   * </ul>
   *
   * <p>Method under test: {@link DefaultHistoryManager#createIdentityLinkComment(String, String,
   * String, String, boolean)}
  ...
  public void testCreateIdentityLinkCommentWithTaskIdUserIdGroupIdTypeCreate_thenCallsCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createIdentityLinkComment("42", "42", "42", "Type", true);
  ...
  public void testCreateUserIdentityLinkCommentWithTaskIdUserIdTypeCreateForceNullUserId() {
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createUserIdentityLinkComment("42", "42", "Type", true, true);
  ...
  public void testCreateUserIdentityLinkCommentWithTaskIdUserIdTypeCreate_thenCallsCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createUserIdentityLinkComment("42", "42", "Type", true);
  ...
  /**
   * Test {@link DefaultHistoryManager#createProcessInstanceIdentityLinkComment(String, String,
   * String, String, boolean)} with {@code processInstanceId}, {@code userId}, {@code groupId},
   * {@code type}, {@code create}.
   *
   * <p>Method under test: {@link
   * DefaultHistoryManager#createProcessInstanceIdentityLinkComment(String, String, String, String,
   * boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void
      testCreateProcessInstanceIdentityLinkCommentWithProcessInstanceIdUserIdGroupIdTypeCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createProcessInstanceIdentityLinkComment("42", "42", "42", "Type", true);
  ...
  /**
   * Test {@link DefaultHistoryManager#createProcessInstanceIdentityLinkComment(String, String,
   * String, String, boolean, boolean)} with {@code processInstanceId}, {@code userId}, {@code
   * groupId}, {@code type}, {@code create}, {@code forceNullUserId}.
   *
   * <p>Method under test: {@link
   * DefaultHistoryManager#createProcessInstanceIdentityLinkComment(String, String, String, String,
   * boolean, boolean)}
  ...
  public void
      testCreateProcessInstanceIdentityLinkCommentWithProcessInstanceIdUserIdGroupIdTypeCreateForceNullUserId() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createProcessInstanceIdentityLinkComment("42", "42", "42", "Type", true, true);
  ...
  public void testCreateGroupIdentityLinkComment_thenCallsCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createGroupIdentityLinkComment("42", "42", "Type", true);
   ...
   *
   * <ul>
   *   <li>Then calls {@link ProcessEngineConfigurationImpl#getClock()}.
   * </ul>
   *
   * <p>Method under test: {@link DefaultHistoryManager#createGroupIdentityLinkComment(String,
   * String, String, boolean)}
  ...
  public void testCreateGroupIdentityLinkComment_thenCallsGetClock() {
    // Arrange
    HistoryManager historyManager = mock(HistoryManager.class);
    when(historyManager.isHistoryEnabled()).thenReturn(true);
    when(processEngineConfigurationImpl.getEventDispatcher())
  ...
  public void testCreateGroupIdentityLinkComment_whenFalse_thenCallsCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createGroupIdentityLinkComment("42", "42", "Type", false);
   ...
   * </ul>
   *
   * <p>Method under test: {@link DefaultHistoryManager#createAttachmentComment(String, String,
   * String, boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DefaultHistoryManager.createAttachmentComment(String, String, String, boolean)"
  })
  public void testCreateAttachmentComment_thenCallsCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createAttachmentComment("42", "42", "Attachment Name", true);
  ...
  public void testCreateAttachmentComment_whenFalse_thenCallsCreate() {
    // Arrange
    CommentEntityManagerImpl commentEntityManager = mock(CommentEntityManagerImpl.class);
    doNothing().when(commentEntityManager).insert(Mockito.<CommentEntity>any());
    when(commentEntityManager.create()).thenReturn(new CommentEntityImpl());
    ...
    // Act
    new DefaultHistoryManager(processEngineConfiguration, HistoryLevel.ACTIVITY)
        .createAttachmentComment("42", "42", "Attachment Name", false);
