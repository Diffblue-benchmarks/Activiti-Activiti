...
public class AbstractBpmnActivityBehaviorDiffblueTest {
  ...
  public void testHasLoopCharacteristics_thenReturnTrue() {
    ...
    serviceTaskJavaDelegateActivityBehavior.setMultiInstanceActivityBehavior(
        multiInstanceActivityBehavior);

    // Act and Assert
    assertTrue(serviceTaskJavaDelegateActivityBehavior.hasLoopCharacteristics());
  }
  ...
  public void testHasMultiInstanceCharacteristics_thenReturnTrue() {
    ...
    // Act and Assert
    assertTrue(serviceTaskJavaDelegateActivityBehavior.hasMultiInstanceCharacteristics());
  }
