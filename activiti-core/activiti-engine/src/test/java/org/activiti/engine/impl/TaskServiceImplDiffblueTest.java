...
public class TaskServiceImplDiffblueTest {
  ...
  public void testSetVariable_thenThrowActivitiIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () ->
            new TaskServiceImpl(new JtaProcessEngineConfiguration())
                .setVariable("42", null, JSONObject.NULL));
  }
  ...
  public void testSetVariableLocal_thenThrowActivitiIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () ->
            new TaskServiceImpl(new JtaProcessEngineConfiguration())
                .setVariableLocal("42", null, JSONObject.NULL));
  }
}
