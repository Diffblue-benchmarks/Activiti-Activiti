...
public class DefaultDelegateInterceptorDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When {@link ActivityBehavior} {@link ActivityBehavior#execute(DelegateExecution)} does
   *       nothing.
   *   <li>Then calls {@link ActivityBehavior#execute(DelegateExecution)}.
   * </ul>
   *
   * <p>Method under test: {@link DefaultDelegateInterceptor#handleInvocation(DelegateInvocation)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void DefaultDelegateInterceptor.handleInvocation(DelegateInvocation)"})
