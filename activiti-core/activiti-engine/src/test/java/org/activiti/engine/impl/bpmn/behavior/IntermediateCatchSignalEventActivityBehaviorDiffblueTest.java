...
public class IntermediateCatchSignalEventActivityBehaviorDiffblueTest {
  /**
   * Test {@link
   * IntermediateCatchSignalEventActivityBehavior#IntermediateCatchSignalEventActivityBehavior(SignalEventDefinition,
   * Signal)}.
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void IntermediateCatchSignalEventActivityBehavior.<init>(SignalEventDefinition, Signal)"
  })
  public void testNewIntermediateCatchSignalEventActivityBehavior() {
    ...
    IntermediateCatchSignalEventActivityBehavior
        actualIntermediateCatchSignalEventActivityBehavior =
            new IntermediateCatchSignalEventActivityBehavior(signalEventDefinition, new Signal());
    ...
    SignalEventDefinition signalEventDefinition2 =
        actualIntermediateCatchSignalEventActivityBehavior.signalEventDefinition;
    ...
    assertNull(
        actualIntermediateCatchSignalEventActivityBehavior.getMultiInstanceActivityBehavior());
    ...
    assertFalse(
        actualIntermediateCatchSignalEventActivityBehavior.hasMultiInstanceCharacteristics());
