...
public class ActivitiEventBuilderDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return TargetActivityBehaviorClass is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link ActivitiEventBuilder#createSequenceFlowTakenEvent(ExecutionEntity,
   * ActivitiEventType, String, String, String, String, Object, String, String, String, Object)}
  ...
  public void testCreateActivityEventWithTypeExecutionFlowElement_thenReturnActivityTypeIsNull() {
    ...
    ActivitiActivityEvent actualCreateActivityEventResult =
        ActivitiEventBuilder.createActivityEvent(
            ActivitiEventType.ENTITY_CREATED, execution, new BooleanDataObject());
  ...
  public void testCreateActivityEventWithTypeExecutionFlowElement_whenAdhocSubProcess() {
    // Arrange
    ExecutionEntityImpl execution = ExecutionEntityImpl.createWithEmptyRelationshipCollections();
  ...
  public void testPopulateEventWithCurrentContext() {
    // Arrange, Act and Assert
    ActivitiEventBuilder.populateEventWithCurrentContext(
   ...
   *
   * <ul>
   *   <li>When {@link ActivitiEventImpl#ActivitiEventImpl(ActivitiEventType)} with type is {@code
   *       ENTITY_CREATED}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testPopulateEventWithCurrentContext_whenActivitiEventImplWithTypeIsEntityCreated() {
    // Arrange, Act and Assert
    ActivitiEventBuilder.populateEventWithCurrentContext(
