...
public class VariableInstanceEntityManagerImplDiffblueTest {
  ...
  public void testCreateWithStringVariableTypeObject_thenPersistentStateReturnMap() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    ...
    VariableInstanceEntity actualCreateResult =
        variableInstanceEntityManagerImpl.create("Name", type, object);
    ...
    VariableType type2 = actualCreateResult.getType();
    assertTrue(type2 instanceof BigDecimalType);
    assertEquals("bigdecimal", actualCreateResult.getTypeName());
    assertEquals("bigdecimal", ((VariableInstanceEntityImpl) actualCreateResult).typeName);
    assertEquals("null", actualCreateResult.getTextValue());
    ...
    assertTrue(((Map<String, String>) persistentState).containsKey("textValue"));
    assertSame(type, type2);
    assertSame(object, actualCreateResult.getValue());
    assertSame(object, actualCreateResult.getCachedValue());
  }
   ...
   *
   * <ul>
   *   <li>Then calls {@link TaskEntity#getVariableInstanceEntities()}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  public void testDeleteVariableInstanceByTask_thenCallsGetVariableInstanceEntities() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    VariableInstanceEntityManagerImpl variableInstanceEntityManagerImpl =
        new VariableInstanceEntityManagerImpl(
