...
public class JobTestHelperDiffblueTest {
   ...
   */
  @Test
  public void testWaitForJobExecutorToProcessAllJobs() {
    // Arrange
   ...
   */
  @Test
  public void testWaitForJobExecutorToProcessAllJobs2() {
    // Arrange
    DefaultAsyncJobExecutor defaultAsyncJobExecutor = new DefaultAsyncJobExecutor();
    defaultAsyncJobExecutor.setProcessEngineConfiguration(new JtaProcessEngineConfiguration());
    JtaProcessEngineConfiguration processEngineConfiguration = mock(JtaProcessEngineConfiguration.class);
   ...
   */
  @Test
  public void testWaitForJobExecutorToProcessAllJobs3() {
    // Arrange
   ...
   */
  @Test
  public void testWaitForJobExecutorToProcessAllJobsAndExecutableTimerJobs() {
    // Arrange
    DefaultAsyncJobExecutor defaultAsyncJobExecutor = new DefaultAsyncJobExecutor();
   ...
   */
  @Test
  public void testWaitForJobExecutorToProcessAllJobsAndExecutableTimerJobs2() {
    // Arrange
    DefaultAsyncJobExecutor defaultAsyncJobExecutor = new DefaultAsyncJobExecutor();
    defaultAsyncJobExecutor.setProcessEngineConfiguration(new StandaloneInMemProcessEngineConfiguration());
    JtaProcessEngineConfiguration processEngineConfiguration = mock(JtaProcessEngineConfiguration.class);
   ...
   */
  @Test
  public void testExecuteJobExecutorForTime() {
    // Arrange
    DefaultAsyncJobExecutor defaultAsyncJobExecutor = new DefaultAsyncJobExecutor();
    defaultAsyncJobExecutor.setProcessEngineConfiguration(new JtaProcessEngineConfiguration());
    JtaProcessEngineConfiguration processEngineConfiguration = mock(JtaProcessEngineConfiguration.class);
   ...
   */
  @Test
  public void testAreJobsAvailable() {
    // Arrange
   ...
   */
  @Test
  public void testAreJobsAvailable2() {
    // Arrange
   ...
   */
  @Test
  public void testAreJobsOrExecutableTimersAvailable() {
    // Arrange
    ArrayList<Job> jobList = new ArrayList<>();
    jobList.add(new DeadLetterJobEntityImpl());
    JobQueryImpl jobQueryImpl = mock(JobQueryImpl.class);
