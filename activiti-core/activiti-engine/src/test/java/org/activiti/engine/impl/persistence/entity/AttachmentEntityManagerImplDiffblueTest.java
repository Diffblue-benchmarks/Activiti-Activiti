...
public class AttachmentEntityManagerImplDiffblueTest {
  ...
  @InjectMocks private AttachmentEntityManagerImpl attachmentEntityManagerImpl;
   ...
   * <ul>
   *   <li>{@link
   *       AttachmentEntityManagerImpl#AttachmentEntityManagerImpl(ProcessEngineConfigurationImpl,
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AttachmentEntityManagerImpl.<init>(ProcessEngineConfigurationImpl, AttachmentDataManager)",
  ...
  public void testGettersAndSetters() {
    ...
    // Act
    AttachmentEntityManagerImpl actualAttachmentEntityManagerImpl =
        new AttachmentEntityManagerImpl(
            processEngineConfiguration,
            new MybatisAttachmentDataManager(new JtaProcessEngineConfiguration()));
    MybatisAttachmentDataManager attachmentDataManager =
        new MybatisAttachmentDataManager(new JtaProcessEngineConfiguration());
    actualAttachmentEntityManagerImpl.setAttachmentDataManager(attachmentDataManager);
    AttachmentDataManager actualAttachmentDataManager =
        actualAttachmentEntityManagerImpl.getAttachmentDataManager();
   ...
   * AttachmentEntityManagerImpl#findAttachmentsByProcessInstanceId(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testFindAttachmentsByProcessInstanceId() {
    ...
    assertThrows(
        ...
        () -> attachmentEntityManagerImpl.findAttachmentsByProcessInstanceId("42"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AttachmentEntityManagerImpl.findAttachmentsByProcessInstanceId(String)"})
  public void testFindAttachmentsByProcessInstanceId_thenCallsGetHistoryManager() {
    // Arrange
    ...
    verify(attachmentDataManager).findAttachmentsByProcessInstanceId("42");
  }
  ...
  public void testFindAttachmentsByProcessInstanceId_thenReturnEmpty() {
    ...
    // Act
    List<AttachmentEntity> actualFindAttachmentsByProcessInstanceIdResult =
        attachmentEntityManagerImpl.findAttachmentsByProcessInstanceId("42");
   ...
   *
   * <p>Method under test: {@link AttachmentEntityManagerImpl#findAttachmentsByTaskId(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testFindAttachmentsByTaskId() {
    ...
    // Act and Assert
    assertThrows(
        ActivitiException.class, () -> attachmentEntityManagerImpl.findAttachmentsByTaskId("42"));
    verify(processEngineConfiguration).getHistoryManager();
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"List AttachmentEntityManagerImpl.findAttachmentsByTaskId(String)"})
  public void testFindAttachmentsByTaskId_thenCallsGetHistoryManager() {
    // Arrange
    when(processEngineConfigurationImpl.getHistoryManager())
        .thenReturn(
            new DefaultHistoryManager(new JtaProcessEngineConfiguration(), HistoryLevel.ACTIVITY));
    ...
    assertThrows(
        ActivitiException.class, () -> attachmentEntityManagerImpl.findAttachmentsByTaskId("42"));
    verify(processEngineConfigurationImpl).getHistoryManager();
    verify(attachmentDataManager).findAttachmentsByTaskId("42");
  }
  ...
  public void testFindAttachmentsByTaskId_thenReturnEmpty() {
    ...
    // Act
    List<AttachmentEntity> actualFindAttachmentsByTaskIdResult =
        attachmentEntityManagerImpl.findAttachmentsByTaskId("42");
   ...
   * </ul>
   *
   * <p>Method under test: {@link AttachmentEntityManagerImpl#deleteAttachmentsByTaskId(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testDeleteAttachmentsByTaskId_thenThrowActivitiException() {
    ...
    // Act and Assert
    assertThrows(
        ActivitiException.class, () -> attachmentEntityManagerImpl.deleteAttachmentsByTaskId("42"));
    verify(processEngineConfiguration).getHistoryManager();
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link AttachmentEntityManagerImpl#checkHistoryEnabled()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCheckHistoryEnabled_thenThrowActivitiException() {
    ...
    // Act and Assert
    assertThrows(ActivitiException.class, () -> attachmentEntityManagerImpl.checkHistoryEnabled());
  }
}
