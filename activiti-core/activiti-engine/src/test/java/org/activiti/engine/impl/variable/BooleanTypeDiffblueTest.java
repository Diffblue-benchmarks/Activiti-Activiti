...
public class BooleanTypeDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link BooleanType#getValue(ValueFields)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Object BooleanType.getValue(ValueFields)"})
  public void testGetValue_givenDetailType_thenReturnTrue() {
    // Arrange
   ...
   *
   * <p>Method under test: {@link BooleanType#setValue(Object, ValueFields)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link BooleanType#isAbleToStore(Object)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  @MethodsUnderTest({
    ...
    "String BooleanType.getTypeName()",
