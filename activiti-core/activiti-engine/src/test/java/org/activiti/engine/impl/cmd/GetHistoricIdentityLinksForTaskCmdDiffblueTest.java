...
public class GetHistoricIdentityLinksForTaskCmdDiffblueTest {
  /**
   * Test {@link GetHistoricIdentityLinksForTaskCmd#GetHistoricIdentityLinksForTaskCmd(String,
   * String)}.
   *
   * <p>Method under test: {@link
   * GetHistoricIdentityLinksForTaskCmd#GetHistoricIdentityLinksForTaskCmd(String, String)}
   */
  @Test
  ...
  public void testNewGetHistoricIdentityLinksForTaskCmd() {
    ...
    assertThrows(
        ...
        () -> new GetHistoricIdentityLinksForTaskCmd(null, null));
  }
   ...
   * <ul>
   *   <li>When {@code 42}.
   *   <li>Then return {@link GetHistoricIdentityLinksForTaskCmd#taskId} is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link
   * GetHistoricIdentityLinksForTaskCmd#GetHistoricIdentityLinksForTaskCmd(String, String)}
  ...
  public void testNewGetHistoricIdentityLinksForTaskCmd_when42_thenReturnTaskIdIs42() {
    // Arrange and Act
    GetHistoricIdentityLinksForTaskCmd actualGetHistoricIdentityLinksForTaskCmd =
        new GetHistoricIdentityLinksForTaskCmd("42", "42");
   ...
   * <ul>
   *   <li>When {@code null}.
   *   <li>Then return {@link GetHistoricIdentityLinksForTaskCmd#taskId} is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link
   * GetHistoricIdentityLinksForTaskCmd#GetHistoricIdentityLinksForTaskCmd(String, String)}
  ...
  public void testNewGetHistoricIdentityLinksForTaskCmd_whenNull_thenReturnTaskIdIsNull() {
    // Arrange and Act
    GetHistoricIdentityLinksForTaskCmd actualGetHistoricIdentityLinksForTaskCmd =
        new GetHistoricIdentityLinksForTaskCmd(null, "42");
