...
public class AbstractBpmnParseHandlerDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Set AbstractBpmnParseHandler.getHandledTypes()"})
  public void testGetHandledTypes() {
    // Arrange and Act
    Set<Class<? extends BaseElement>> actualHandledTypes =
        new AdhocSubProcessParseHandler().getHandledTypes();

    // Assert
    assertEquals(1, actualHandledTypes.size());
    assertTrue(actualHandledTypes.contains(AdhocSubProcess.class));
  }
  ...
  public void testGetPrecedingEventBasedGateway2() {
    ...
    ArrayList<SequenceFlow> incomingFlows = new ArrayList<>();
    incomingFlows.add(new SequenceFlow("start", "Target Ref"));
   ...
   *
   * <ul>
   *   <li>Given {@link SubProcess} (default constructor) addFlowElement {@link SubProcess} (default
   *       constructor).
   * </ul>
   *
  ...
  public void testProcessArtifacts_givenSubProcessAddFlowElementSubProcess() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();

    SubProcess element = new SubProcess();
    element.addFlowElement(new SubProcess());
  ...
  public void testCreateAssociation_givenAdhocSubProcessGetArtifactReturnAssociation() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AbstractBpmnParseHandler.createAssociation(BpmnParse, Association)"})
  public void testCreateAssociation_givenAdhocSubProcessGetArtifactReturnAssociation2() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
    ...
    when(adhocSubProcess2.getFlowElements()).thenReturn(flowElementList);
    when(adhocSubProcess2.getArtifact(Mockito.<String>any())).thenReturn(null);

    ArrayList<SubProcess> subProcessList = new ArrayList<>();
    subProcessList.add(adhocSubProcess2);
    ...
    verify(process, atLeast(1)).findFlowElementsOfType(isA(Class.class));
    verify(process).getArtifact(null);
    verify(adhocSubProcess2).getArtifact(null);
    verify(adhocSubProcess).getArtifact(null);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AbstractBpmnParseHandler.createAssociation(BpmnParse, Association)"})
  public void testCreateAssociation_givenArrayListAddAdhocSubProcess_thenCallsGetFlowElements() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
    ...
    AdhocSubProcess adhocSubProcess = mock(AdhocSubProcess.class);
    when(adhocSubProcess.getFlowElements()).thenReturn(flowElementList);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AbstractBpmnParseHandler.createAssociation(BpmnParse, Association)"})
  public void testCreateAssociation_givenArrayListAddNull_thenCallsGetFlowElements() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
   ...
   *   <li>Then calls {@link Process#addArtifact(Artifact)}.
   * </ul>
   *
   * <p>Method under test: {@link AbstractBpmnParseHandler#createAssociation(BpmnParse,
   * Association)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AbstractBpmnParseHandler.createAssociation(BpmnParse, Association)"})
  public void testCreateAssociation_givenArrayListAddSubProcess_thenCallsAddArtifact() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AbstractBpmnParseHandler.createAssociation(BpmnParse, Association)"})
  public void testCreateAssociation_givenProcessGetArtifactReturnNull_thenCallsAddArtifact() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void AbstractBpmnParseHandler.createAssociation(BpmnParse, Association)"})
  public void testCreateAssociation_thenCallsGetFlowElements() {
    // Arrange
    AdhocSubProcessParseHandler adhocSubProcessParseHandler = new AdhocSubProcessParseHandler();
