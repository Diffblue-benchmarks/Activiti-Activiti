...
public class DoubleTypeDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link DoubleType#getValue(ValueFields)}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link DoubleType#setValue(Object, ValueFields)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link DoubleType#isAbleToStore(Object)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
