...
public class XMLDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void XML.noSpace(String)"})
  public void testNoSpace_whenString_thenDoesNotThrow() throws JSONException {
    // Arrange, Act and Assert
    XML.noSpace("String");
  }
   ...
   * <ul>
   *   <li>Given {@code Opt}.
   *   <li>Then return {@code <Tag Name><null>Opt</null></Tag Name>}.
   * </ul>
   *
   * <p>Method under test: {@link XML#toString(Object, String)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object, String)"})
  public void testToStringWithOTagName_givenOpt_thenReturnTagNameNullOptNullTagName()
      throws JSONException {
    // Arrange
    ArrayList<Object> objectList = new ArrayList<>();
    objectList.add(JSONObject.NULL);
    ...
    JSONObject jsonObject = mock(JSONObject.class);
    when(jsonObject.opt(Mockito.<String>any())).thenReturn("Opt");
    when(jsonObject.keys()).thenReturn(iteratorResult);
    ...
    verify(jsonObject).keys();
    verify(jsonObject).opt("null");
    assertEquals("<Tag Name><null>Opt</null></Tag Name>", actualToStringResult);
  }
   ...
   * <ul>
   *   <li>Given {@code false}.
   *   <li>When {@link JSONArray#JSONArray()} {@code false}.
   *   <li>Then return {@code <array>false</array>}.
   * </ul>
   *
   * <p>Method under test: {@link XML#toString(Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_givenFalse_whenJSONArrayFalse_thenReturnArrayFalseArray()
      throws JSONException {
    // Arrange
   ...
   *   <li>When {@link JSONObject#JSONObject()} {@code Key} is {@link HashMap#HashMap()}.
   *   <li>Then return {@code <Key></Key>}.
   * </ul>
   *
   * <p>Method under test: {@link XML#toString(Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_givenHashMap_whenJSONObjectKeyIsHashMap_thenReturnKeyKey()
      throws JSONException {
    // Arrange
    JSONObject jsonObject = new JSONObject();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_givenJSONArray_thenReturnKeyKey() throws JSONException {
    // Arrange
    JSONObject jsonObject = new JSONObject();
   ...
   * <ul>
   *   <li>Given {@link JSONObject#NULL}.
   *   <li>When {@link JSONObject#JSONObject()} append {@code content} and {@link JSONObject#NULL}.
   *   <li>Then return {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link XML#toString(Object)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_givenNull_whenJSONObjectAppendContentAndNull_thenReturnNull()
      throws JSONException {
    // Arrange
    JSONObject jsonObject = new JSONObject();
   ...
   * <ul>
   *   <li>Given {@link JSONObject#NULL}.
   *   <li>When {@link JSONObject#JSONObject()} append {@code Key} and {@link JSONObject#NULL}.
   *   <li>Then return {@code <Key>null</Key>}.
   * </ul>
   *
   * <p>Method under test: {@link XML#toString(Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_givenNull_whenJSONObjectAppendKeyAndNull_thenReturnKeyNullKey()
      throws JSONException {
    // Arrange
    JSONObject jsonObject = new JSONObject();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_whenJSONObjectAppendContentAndNull_thenReturnNullNull()
      throws JSONException {
    // Arrange
    JSONObject jsonObject = new JSONObject();
    jsonObject.append("content", JSONObject.NULL);
   ...
   *
   * <ul>
   *   <li>When {@link JSONObject#JSONObject()} increment {@code content}.
   *   <li>Then return {@code 1<Key></Key>}.
   * </ul>
   *
   * <p>Method under test: {@link XML#toString(Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String XML.toString(Object)"})
  public void testToStringWithO_whenJSONObjectIncrementContent_thenReturn1KeyKey()
      throws JSONException {
    // Arrange
    JSONObject jsonObject = new JSONObject();
    jsonObject.increment("content");
    jsonObject.append("Key", new JSONArray());

    // Act and Assert
    assertEquals("1<Key></Key>", XML.toString(jsonObject));
  }
