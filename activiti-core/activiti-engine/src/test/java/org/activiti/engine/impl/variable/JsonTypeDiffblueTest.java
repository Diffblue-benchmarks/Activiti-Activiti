...
public class JsonTypeDiffblueTest {
  ...
  public void testGetValue3() {
    ...
    valueFields.setUpdated(true);
    valueFields.setVariableType(new BigDecimalType());
    valueFields.setTextValue("com.fasterxml.jackson.databind.node.IntNode");
    valueFields.setTextValue2("42");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object JsonType.getValue(ValueFields)"})
  public void testGetValue_givenNull() {
    // Arrange
    JsonMapper objectMapper = JsonMapper.builder().findAndAddModules().build();
    JsonMapper objectMapper2 = JsonMapper.builder().findAndAddModules().build();
    JsonTypeConverter jsonTypeConverter =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object JsonType.getValue(ValueFields)"})
  public void testGetValue_thenReturnIntNode() {
    // Arrange
    JsonMapper objectMapper = JsonMapper.builder().findAndAddModules().build();
    JsonMapper objectMapper2 = JsonMapper.builder().findAndAddModules().build();
    JsonTypeConverter jsonTypeConverter =
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void JsonType.setValue(Object, ValueFields)"})
  public void testSetValue_thenHistoricDetailVariableInstanceUpdateEntityImplTextValueIsIdNull() {
    // Arrange
    JsonMapper objectMapper = JsonMapper.builder().findAndAddModules().build();
    JsonMapper objectMapper2 = JsonMapper.builder().findAndAddModules().build();
    JsonTypeConverter jsonTypeConverter =
    ...
    // Act
    jsonType.setValue(createConfigResponse, valueFields);

    // Assert
    assertEquals(
        "com.github.dockerjava.api.command.CreateConfigResponse", valueFields.getTextValue2());
    assertEquals("{\"ID\":null}", valueFields.getTextValue());
  }
  ...
  public void testIsAbleToStore() {
    ...
    // Act and Assert
    assertFalse(jsonType.isAbleToStore(new CreateConfigResponse()));
  }
  ...
  public void testIsAbleToStore2() {
    ...
    JsonType jsonType = new JsonType(11, objectMapper, true, jsonTypeConverter);

    // Act and Assert
    assertTrue(jsonType.isAbleToStore(new CreateConfigResponse()));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean JsonType.isAbleToStore(Object)"})
  public void testIsAbleToStore_whenCreateConfigResponse_thenReturnFalse() {
    // Arrange
    JsonMapper objectMapper = JsonMapper.builder().findAndAddModules().build();
    JsonMapper objectMapper2 = JsonMapper.builder().findAndAddModules().build();
    JsonTypeConverter jsonTypeConverter =
