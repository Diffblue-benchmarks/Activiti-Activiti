...
public class CompensateEventDefinitionParseHandlerDiffblueTest {
  /**
   * Test {@link CompensateEventDefinitionParseHandler#executeParse(BpmnParse,
   * CompensateEventDefinition)} with {@code BpmnParse}, {@code CompensateEventDefinition}.
   *
   * <p>Method under test: {@link CompensateEventDefinitionParseHandler#executeParse(BpmnParse,
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CompensateEventDefinitionParseHandler.executeParse(BpmnParse, CompensateEventDefinition)"
  })
  public void testExecuteParseWithBpmnParseCompensateEventDefinition() {
    // Arrange
    CompensateEventDefinitionParseHandler compensateEventDefinitionParseHandler =
    ...
    assertTrue(
        ((ThrowEvent) currentFlowElement).getBehavior()
