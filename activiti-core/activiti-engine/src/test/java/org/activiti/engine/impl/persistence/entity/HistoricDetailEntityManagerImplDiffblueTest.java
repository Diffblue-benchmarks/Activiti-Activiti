...
public class HistoricDetailEntityManagerImplDiffblueTest {
  @Mock private HistoricDetailDataManager historicDetailDataManager;

  @InjectMocks private HistoricDetailEntityManagerImpl historicDetailEntityManagerImpl;
   ...
   *
   * <ul>
   *   <li>Then calls {@link MybatisHistoricDetailDataManager#delete(Entity)}.
   * </ul>
   *
   * <p>Method under test: {@link HistoricDetailEntityManagerImpl#delete(HistoricDetailEntity,
   * boolean)}
