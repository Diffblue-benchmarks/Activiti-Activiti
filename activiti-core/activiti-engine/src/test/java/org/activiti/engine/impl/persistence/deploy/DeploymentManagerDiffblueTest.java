...
public class DeploymentManagerDiffblueTest {
  /**
   * Test {@link DeploymentManager#deploy(DeploymentEntity, Map)} with {@code deployment}, {@code
   * deploymentSettings}.
   *
   * <p>Method under test: {@link DeploymentManager#deploy(DeploymentEntity, Map)}
   */
  @Test
   ...
   *
   * <ul>
   *   <li>Given {@link Deployer} {@link Deployer#deploy(DeploymentEntity, Map)} does nothing.
   * </ul>
   *
   * <p>Method under test: {@link DeploymentManager#deploy(DeploymentEntity, Map)}
   */
   ...
   * <ul>
   *   <li>Given {@link Deployer} {@link Deployer#deploy(DeploymentEntity, Map)} does nothing.
   *   <li>Then calls {@link Deployer#deploy(DeploymentEntity, Map)}.
   * </ul>
   *
   * <p>Method under test: {@link DeploymentManager#deploy(DeploymentEntity)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   * </ul>
   *
   * <p>Method under test: {@link DeploymentManager#findDeployedProcessDefinitionById(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ProcessDefinition DeploymentManager.findDeployedProcessDefinitionById(String)"
  })
   ...
   *
   * <ul>
   *   <li>Then calls {@link ProcessDefinitionCacheEntry#getProcessDefinition()}.
   * </ul>
   *
   * <p>Method under test: {@link DeploymentManager#findDeployedProcessDefinitionById(String)}
   */
  ...
  public void testFindDeployedProcessDefinitionById_thenCallsGetProcessDefinition() {
    ...
    ProcessDefinitionCacheEntry processDefinitionCacheEntry =
        mock(ProcessDefinitionCacheEntry.class);
   ...
   * DeploymentManager#findDeployedLatestProcessDefinitionByKey(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ProcessDefinition DeploymentManager.findDeployedLatestProcessDefinitionByKey(String)"
  })
  ...
  public void testFindDeployedLatestProcessDefinitionByKey2() {
    // Arrange
  ...
  /**
   * Test {@link DeploymentManager#findDeployedLatestProcessDefinitionByKeyAndTenantId(String,
   * String)}.
   *
   * <p>Method under test: {@link
   * DeploymentManager#findDeployedLatestProcessDefinitionByKeyAndTenantId(String, String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testFindDeployedLatestProcessDefinitionByKeyAndTenantId2() {
    // Arrange
    ProcessDefinitionEntityImpl processDefinitionEntityImpl =
        mock(ProcessDefinitionEntityImpl.class);
    when(processDefinitionEntityImpl.getId())
  ...
  /**
   * Test {@link DeploymentManager#findDeployedProcessDefinitionByKeyAndVersionAndTenantId(String,
   * Integer, String)}.
   *
   * <p>Method under test: {@link
   * DeploymentManager#findDeployedProcessDefinitionByKeyAndVersionAndTenantId(String, Integer,
   * String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testFindDeployedProcessDefinitionByKeyAndVersionAndTenantId2() {
    // Arrange
    ProcessDefinitionEntityImpl processDefinitionEntityImpl =
        mock(ProcessDefinitionEntityImpl.class);
    when(processDefinitionEntityImpl.getId())
   ...
   *
   * <p>Method under test: {@link DeploymentManager#resolveProcessDefinition(ProcessDefinition)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ProcessDefinitionCacheEntry DeploymentManager.resolveProcessDefinition(ProcessDefinition)"
  })
  public void testResolveProcessDefinition() {
    // Arrange
    DeploymentCache<ProcessDefinitionCacheEntry> processDefinitionCache =
        mock(DeploymentCache.class);
    ProcessDefinitionEntityImpl processDefinition = new ProcessDefinitionEntityImpl();
    BpmnModel bpmnModel = TestProcessUtil.createOneTaskBpmnModel();
    ...
    // Act
    ProcessDefinitionCacheEntry actualResolveProcessDefinitionResult =
        deploymentManager.resolveProcessDefinition(new ProcessDefinitionEntityImpl());

    // Assert
    verify(processDefinitionCache).get(null);
   ...
   * </ul>
   *
   * <p>Method under test: {@link DeploymentManager#removeDeployment(String, boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testRemoveDeployment_thenThrowActivitiObjectNotFoundException() {
    ...
    deploymentEntityManager.insert(new DeploymentEntityImpl(), false);
    ...
    assertThrows(
        ActivitiObjectNotFoundException.class,
        () -> deploymentManager.removeDeployment("42", true));
    verify(deploymentDataManager).findById("42");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DeploymentManager.<init>()",
    "List DeploymentManager.getDeployers()",
  ...
  public void testGettersAndSetters() {
    ...
    DeploymentEntityManager actualDeploymentEntityManager =
        actualDeploymentManager.getDeploymentEntityManager();
    DeploymentCache<Object> actualKnowledgeBaseCache =
        actualDeploymentManager.getKnowledgeBaseCache();
    DeploymentCache<ProcessDefinitionCacheEntry> actualProcessDefinitionCache =
        actualDeploymentManager.getProcessDefinitionCache();
    ProcessDefinitionEntityManager actualProcessDefinitionEntityManager =
        actualDeploymentManager.getProcessDefinitionEntityManager();
    ProcessDefinitionInfoCache actualProcessDefinitionInfoCache =
        actualDeploymentManager.getProcessDefinitionInfoCache();
    ProcessEngineConfigurationImpl actualProcessEngineConfiguration =
        actualDeploymentManager.getProcessEngineConfiguration();
