...
public class ProcessExecutionLoggerDiffblueTest {
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link ProcessExecutionLogger}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link ProcessExecutionLogger#generateExecutionTrees()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link ProcessExecutionLogger#logDebugInfo(boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link ProcessExecutionLogger} (default constructor).
   *   <li>When {@code false}.
   * </ul>
   *
   * <p>Method under test: {@link ProcessExecutionLogger#logDebugInfo(boolean)}
   ...
   *
   * <ul>
   *   <li>Then {@link ProcessExecutionLogger} (default constructor) {@link
   *       ProcessExecutionLogger#createdExecutions} size is one.
   * </ul>
   *
   * <p>Method under test: {@link ProcessExecutionLogger#executionCreated(ExecutionEntity)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testExecutionCreated_thenProcessExecutionLoggerCreatedExecutionsSizeIsOne() {
    ...
    // Assert
    Map<String, ExecutionEntity> stringExecutionEntityMap =
   ...
   * <ul>
   *   <li>Then {@link ProcessExecutionLogger} (default constructor) {@link
   *       ProcessExecutionLogger#deletedExecutions} size is one.
   * </ul>
   *
   * <p>Method under test: {@link ProcessExecutionLogger#executionDeleted(ExecutionEntity)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
