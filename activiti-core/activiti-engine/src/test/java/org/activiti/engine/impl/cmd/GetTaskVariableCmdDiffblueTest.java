...
public class GetTaskVariableCmdDiffblueTest {
   ...
   * <p>
   * Method under test:
   * {@link GetTaskVariableCmd#GetTaskVariableCmd(String, String, boolean)}
   */
  @Test
  public void testNewGetTaskVariableCmd() {
    ...
    assertEquals("Variable Name", actualGetTaskVariableCmd.variableName);
    assertTrue(actualGetTaskVariableCmd.isLocal);
  }
}
