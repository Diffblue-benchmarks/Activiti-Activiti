...
public class DelegateExpressionTransactionDependentExecutionListenerDiffblueTest {
  ...
  public void testNotifyWithStringStringFlowElementMapMap_givenFixedValueWithValueIsNull() {
    // Arrange
    DelegateExpressionTransactionDependentExecutionListener
        delegateExpressionTransactionDependentExecutionListener =
            new DelegateExpressionTransactionDependentExecutionListener(
  ...
  public void testNotifyWithStringStringFlowElementMapMap_givenFixedValueWithValueIsNull2() {
    // Arrange
    DelegateExpressionTransactionDependentExecutionListener
        delegateExpressionTransactionDependentExecutionListener =
            new DelegateExpressionTransactionDependentExecutionListener(
                new FixedValue(JSONObject.NULL));
    FixedValue expression = new FixedValue(delegateExpressionTransactionDependentExecutionListener);
    DelegateExpressionTransactionDependentExecutionListener
        delegateExpressionTransactionDependentExecutionListener2 =
            new DelegateExpressionTransactionDependentExecutionListener(expression);
    AdhocSubProcess flowElement = new AdhocSubProcess();
    HashMap<String, Object> executionVariables = new HashMap<>();
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () ->
            delegateExpressionTransactionDependentExecutionListener2.notify(
                "42", "42", flowElement, executionVariables, new HashMap<>()));
  }
  ...
  public void testNotifyWithStringStringFlowElementMapMap_thenCallsGetValue() {
    // Arrange
  ...
  public void testNotifyWithStringStringFlowElementMapMap_thenDoesNotThrow() {
    // Arrange
    DelegateExpressionTransactionDependentExecutionListener
        delegateExpressionTransactionDependentExecutionListener =
            new DelegateExpressionTransactionDependentExecutionListener(
                new FixedValue(new CurrentActivityTransactionDependentExecutionListener()));
    AdhocSubProcess flowElement = new AdhocSubProcess();
    HashMap<String, Object> executionVariables = new HashMap<>();
  ...
  public void testNotifyWithStringStringFlowElementMapMap_thenDoesNotThrow2() {
    // Arrange
    DelegateExpressionTransactionDependentExecutionListener
        delegateExpressionTransactionDependentExecutionListener =
            new DelegateExpressionTransactionDependentExecutionListener(
