...
public class DeploymentEntityManagerImplDiffblueTest {
  ...
  public void testInsertWithDeploymentEntity_thenCallsGetId() {
    ...
    stringResourceEntityMap.put("Key", new ResourceEntityImpl());
   ...
   *
   * <ul>
   *   <li>Then calls {@link JtaProcessEngineConfiguration#getIdentityLinkEntityManager()}.
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>Then calls {@link JtaProcessEngineConfiguration#getEventSubscriptionEntityManager()}.
   * </ul>
   *
  ...
  public void testDeleteEventSubscriptions_thenCallsGetEventSubscriptionEntityManager() {
    ...
    JtaProcessEngineConfiguration processEngineConfiguration =
        mock(JtaProcessEngineConfiguration.class);
    when(processEngineConfiguration.getEventSubscriptionEntityManager())
    ...
    // Assert
    verify(processEngineConfiguration).getEventSubscriptionEntityManager();
   ...
   *
   * <ul>
   *   <li>Then calls {@link JtaProcessEngineConfiguration#getProcessDefinitionInfoEntityManager()}.
   * </ul>
   *
  ...
  public void testDeleteProcessDefinitionInfo_thenCallsGetProcessDefinitionInfoEntityManager() {
    // Arrange
    ...
    JtaProcessEngineConfiguration processEngineConfiguration =
        mock(JtaProcessEngineConfiguration.class);
    when(processEngineConfiguration.getProcessDefinitionInfoEntityManager())
    ...
    // Assert
    verify(processEngineConfiguration).getProcessDefinitionInfoEntityManager();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeploymentEntityManagerImpl.deleteProcessDefinitionInfo(String)"})
  public void testDeleteProcessDefinitionInfo_thenCallsGetProcessDefinitionInfoEntityManager2() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
  ...
  public void testRemoveTimerStartJobs() {
    ...
    JtaProcessEngineConfiguration processEngineConfiguration2 =
        mock(JtaProcessEngineConfiguration.class);
    when(processEngineConfiguration2.getEventDispatcher()).thenReturn(activitiEventDispatcher);
    when(processEngineConfiguration2.getTimerJobEntityManager())
    ...
    verify(activitiEventDispatcher).isEnabled();
    verify(processEngineConfiguration2, atLeast(1)).getEventDispatcher();
    verify(processEngineConfiguration2, atLeast(1)).getTimerJobEntityManager();
  ...
  public void testRemoveTimerStartJobs2() {
    ...
    verify(activitiEventDispatcher).isEnabled();
    verify(eventDispatcher, atLeast(1)).isEnabled();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeploymentEntityManagerImpl.removeTimerStartJobs(String)"})
  public void testRemoveTimerStartJobs_thenCallsGetEventDispatcher() {
    // Arrange
    ArrayList<TimerJobEntity> timerJobEntityList = new ArrayList<>();
    timerJobEntityList.add(new TimerJobEntityImpl());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeploymentEntityManagerImpl.removeTimerStartJobs(String)"})
  public void testRemoveTimerStartJobs_thenCallsGetEventDispatcher2() {
    // Arrange
    ArrayList<TimerJobEntity> timerJobEntityList = new ArrayList<>();
    timerJobEntityList.add(new TimerJobEntityImpl());
   ...
   *
   * <ul>
   *   <li>Then calls {@link JtaProcessEngineConfiguration#getTimerJobEntityManager()}.
   * </ul>
   *
   * <p>Method under test: {@link DeploymentEntityManagerImpl#removeTimerStartJobs(String)}
   */
  ...
  public void testRestoreSignalStartEvent_givenNull() {
    // Arrange
    SignalEventSubscriptionEntity signalEventSubscriptionEntity =
        mock(SignalEventSubscriptionEntity.class);
    doNothing().when(signalEventSubscriptionEntity).setActivityId(Mockito.<String>any());
    ...
    EventSubscriptionEntityManager eventSubscriptionEntityManager =
        mock(EventSubscriptionEntityManager.class);
    doNothing().when(eventSubscriptionEntityManager).insert(Mockito.<EventSubscriptionEntity>any());
    when(eventSubscriptionEntityManager.createSignalEventSubscription())
        .thenReturn(signalEventSubscriptionEntity);

    JtaProcessEngineConfiguration processEngineConfiguration =
        mock(JtaProcessEngineConfiguration.class);
    when(processEngineConfiguration.getEventSubscriptionEntityManager())
        .thenReturn(eventSubscriptionEntityManager);
    ...
    verify(processEngineConfiguration, atLeast(1)).getEventSubscriptionEntityManager();
    verify(previousProcessDefinition).getId();
    verify(eventSubscriptionEntityManager).insert(isA(EventSubscriptionEntity.class));
    verify(signalEventSubscriptionEntity).setActivityId("42");
    verify(signalEventSubscriptionEntity).setEventName(null);
    verify(signalEventSubscriptionEntity).setProcessDefinitionId("42");
    verify(eventSubscriptionEntityManager).createSignalEventSubscription();
  ...
  public void testRestoreSignalStartEvent_thenCallsDispatchEvent() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Then calls {@link EventSubscriptionEntityManager#insert(Entity)}.
   * </ul>
   *
   * <p>Method under test: {@link
   * DeploymentEntityManagerImpl#restoreSignalStartEvent(ProcessDefinition, BpmnModel, StartEvent,
  ...
  public void testRestoreSignalStartEvent_thenCallsInsert() {
    // Arrange
    SignalEventSubscriptionEntity signalEventSubscriptionEntity =
        mock(SignalEventSubscriptionEntity.class);
    doNothing().when(signalEventSubscriptionEntity).setActivityId(Mockito.<String>any());
