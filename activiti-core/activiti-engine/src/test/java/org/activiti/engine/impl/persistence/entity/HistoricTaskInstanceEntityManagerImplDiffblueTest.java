...
public class HistoricTaskInstanceEntityManagerImplDiffblueTest {
   ...
   */
  @Test
  public void testFindHistoricTaskInstanceCountByQueryCriteria() {
    // Arrange
   ...
   */
  @Test
  public void testFindHistoricTaskInstancesByQueryCriteria() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    processEngineConfiguration
        .setHistoryManager(new DefaultHistoryManager(new JtaProcessEngineConfiguration(), HistoryLevel.NONE));
   ...
   */
  @Test
  public void testFindHistoricTaskInstancesAndVariablesByQueryCriteria() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    processEngineConfiguration
        .setHistoryManager(new DefaultHistoryManager(new JtaProcessEngineConfiguration(), HistoryLevel.NONE));
  ...
  public void testFindHistoricTaskInstancesByNativeQuery() {
    ...
    assertSame(historicTaskInstanceList, actualFindHistoricTaskInstancesByNativeQueryResult);
  }
   ...
   */
  @Test
  public void testFindHistoricTaskInstanceCountByNativeQuery() {
    // Arrange
    HistoricTaskInstanceDataManager historicTaskInstanceDataManager = mock(HistoricTaskInstanceDataManager.class);
