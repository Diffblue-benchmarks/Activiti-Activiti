...
public class MybatisProcessDefinitionInfoDataManagerDiffblueTest {
   ...
   * <ul>
   *   <li>{@link
   *       MybatisProcessDefinitionInfoDataManager#MybatisProcessDefinitionInfoDataManager(ProcessEngineConfigurationImpl)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MybatisProcessDefinitionInfoDataManager.<init>(ProcessEngineConfigurationImpl)",
    "Class MybatisProcessDefinitionInfoDataManager.getManagedEntityClass()"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    Class<? extends ProcessDefinitionInfoEntity> actualManagedEntityClass =
        new MybatisProcessDefinitionInfoDataManager(new JtaProcessEngineConfiguration())
            .getManagedEntityClass();

    // Assert
    Class<ProcessDefinitionInfoEntityImpl> expectedManagedEntityClass =
        ProcessDefinitionInfoEntityImpl.class;
   ...
   *
   * <p>Method under test: {@link MybatisProcessDefinitionInfoDataManager#create()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ProcessDefinitionInfoEntity MybatisProcessDefinitionInfoDataManager.create()"
  })
  public void testCreate() {
    // Arrange and Act
    ProcessDefinitionInfoEntity actualCreateResult =
        new MybatisProcessDefinitionInfoDataManager(new JtaProcessEngineConfiguration()).create();
