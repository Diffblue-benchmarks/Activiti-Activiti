...
public class DelegateExpressionTransactionDependentTaskListenerDiffblueTest {
  ...
  public void testNotifyWithStringStringTaskMapMap_givenFixedValueWithValueIsNull() {
    // Arrange
    DelegateExpressionTransactionDependentTaskListener
        delegateExpressionTransactionDependentTaskListener =
            new DelegateExpressionTransactionDependentTaskListener(new FixedValue(JSONObject.NULL));
  ...
  public void testNotifyWithStringStringTaskMapMap_givenFixedValueWithValueIsNull2() {
    // Arrange
    DelegateExpressionTransactionDependentTaskListener
        delegateExpressionTransactionDependentTaskListener =
            new DelegateExpressionTransactionDependentTaskListener(new FixedValue(JSONObject.NULL));
    FixedValue expression = new FixedValue(delegateExpressionTransactionDependentTaskListener);
    DelegateExpressionTransactionDependentTaskListener
        delegateExpressionTransactionDependentTaskListener2 =
            new DelegateExpressionTransactionDependentTaskListener(expression);
    Task task = new Task();
    HashMap<String, Object> executionVariables = new HashMap<>();
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () ->
            delegateExpressionTransactionDependentTaskListener2.notify(
                "42", "42", task, executionVariables, new HashMap<>()));
  }
  ...
  public void testNotifyWithStringStringTaskMapMap_thenCallsGetValue() {
    // Arrange
  ...
  public void testNotifyWithStringStringTaskMapMap_thenDoesNotThrow() {
    // Arrange
    DelegateExpressionTransactionDependentTaskListener
        delegateExpressionTransactionDependentTaskListener =
            new DelegateExpressionTransactionDependentTaskListener(
                new FixedValue(new CurrentTaskTransactionDependentTaskListener()));
    Task task = new Task();
    HashMap<String, Object> executionVariables = new HashMap<>();
  ...
  public void testNotifyWithStringStringTaskMapMap_thenDoesNotThrow2() {
    // Arrange
    DelegateExpressionTransactionDependentTaskListener
        delegateExpressionTransactionDependentTaskListener =
            new DelegateExpressionTransactionDependentTaskListener(
