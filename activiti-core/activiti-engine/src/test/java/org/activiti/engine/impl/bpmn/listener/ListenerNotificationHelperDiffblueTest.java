...
public class ListenerNotificationHelperDiffblueTest {
  /**
   * Test {@link ListenerNotificationHelper#invokeCustomPropertiesResolver(DelegateExecution,
   ...
   * ListenerNotificationHelper#invokeCustomPropertiesResolver(DelegateExecution,
   * CustomPropertiesResolver)}
   */
  @Test
  ...
  public void testInvokeCustomPropertiesResolver_givenHashMap_thenReturnEmpty() {
    ...
    // Act
    Map<String, Object> actualInvokeCustomPropertiesResolverResult =
        listenerNotificationHelper.invokeCustomPropertiesResolver(
            execution, customPropertiesResolver);
  ...
  /**
   * Test {@link ListenerNotificationHelper#addTransactionListener(ActivitiListener,
   * TransactionListener)}.
   *
   * <ul>
   *   <li>Given {@code On Transaction}.
   *   <li>Then calls {@link ActivitiListener#getOnTransaction()}.
   * </ul>
   *
   * <p>Method under test: {@link
   * ListenerNotificationHelper#addTransactionListener(ActivitiListener, TransactionListener)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ListenerNotificationHelper.addTransactionListener(ActivitiListener, TransactionListener)"
  })
  public void testAddTransactionListener_givenOnTransaction_thenCallsGetOnTransaction() {
    ...
    // Act
    listenerNotificationHelper.addTransactionListener(
        activitiListener, mock(TransactionListener.class));
