...
public class AbstractSetProcessDefinitionStateCmdDiffblueTest {
  ...
  public void testExecuteInternal_whenArrayList_thenDoesNotThrow() {
    // Arrange
    ProcessDefinitionEntityImpl processDefinitionEntity = new ProcessDefinitionEntityImpl();
    Date executionDate =
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
    ...
    // Act and Assert
    activateProcessDefinitionCmd.executeInternal(null, new ArrayList<>());
  }
  ...
  public void testExecuteInternal_whenArrayList_thenDoesNotThrow2() {
    // Arrange
    ActivateProcessDefinitionCmd activateProcessDefinitionCmd =
        new ActivateProcessDefinitionCmd(new ProcessDefinitionEntityImpl(), true, null, "42");
  ...
  public void testCreateTimerForDelayedExecution_whenArrayList_thenDoesNotThrow() {
    // Arrange
    ProcessDefinitionEntityImpl processDefinitionEntity = new ProcessDefinitionEntityImpl();
    Date executionDate =
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
    ...
    // Act and Assert
    activateProcessDefinitionCmd.createTimerForDelayedExecution(null, new ArrayList<>());
  }
  ...
  public void testChangeProcessDefinitionState_whenArrayList_thenDoesNotThrow() {
    // Arrange
    ProcessDefinitionEntityImpl processDefinitionEntity = new ProcessDefinitionEntityImpl();
    Date executionDate =
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
    ...
    // Act and Assert
    activateProcessDefinitionCmd.changeProcessDefinitionState(null, new ArrayList<>());
  }
}
