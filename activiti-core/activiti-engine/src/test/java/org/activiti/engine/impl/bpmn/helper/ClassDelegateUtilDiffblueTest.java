...
public class ClassDelegateUtilDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object ClassDelegateUtil.instantiateDelegate(Class, List)"})
  public void testInstantiateDelegateWithClazzFieldDeclarations_whenArrayList_thenDoesNotThrow() {
    // Arrange
    Class<Object> clazz = Object.class;

    // Act
    ClassDelegateUtil.instantiateDelegate(clazz, new ArrayList<>());
  }
  ...
  public void testApplyFieldDeclarationWithFieldDeclarationsTarget_whenArrayList() {
    ...
    ClassDelegateUtil.applyFieldDeclaration(new ArrayList<>(), JSONObject.NULL);
  }
  ...
  public void testApplyFieldDeclarationWithFieldDeclarationsTarget_whenNull_thenDoesNotThrow() {
    // Arrange, Act and Assert
    ClassDelegateUtil.applyFieldDeclaration((List<FieldDeclaration>) null, JSONObject.NULL);
  }
