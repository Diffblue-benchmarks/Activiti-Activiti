...
public class DbSqlSessionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link DbSqlSession#executeMandatorySchemaResource(String, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testFindMatchingVersionIndex_thenReturnMinusOne() {
    ...
    // Act and Assert
    assertEquals(-1, (new DbSqlSession(dbSqlSessionFactory, new EntityCacheImpl())).findMatchingVersionIndex("1.0.2"));
  }
  ...
  public void testFindMatchingVersionIndex_when57_thenReturnZero() {
    ...
    // Act and Assert
    assertEquals(0, (new DbSqlSession(dbSqlSessionFactory, new EntityCacheImpl())).findMatchingVersionIndex("5.7"));
  }
  ...
  public void testIsTablePresent() throws SQLException {
    ...
    Environment environment = (new Builder("42")).dataSource(mock(DataSource.class))
   ...
   * Test {@link DbSqlSession#isTablePresent(String)}.
   * <ul>
   *   <li>Given {@link DbSqlSessionFactory} (default constructor) DatabaseCatalog is {@code postgres}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DbSqlSession#isTablePresent(String)}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean DbSqlSession.isTablePresent(String)"})
  public void testIsTablePresent_givenDbSqlSessionFactoryDatabaseCatalogIsPostgres() throws SQLException {
    // Arrange
    DatabaseMetaData databaseMetaData = mock(DatabaseMetaData.class);
    when(databaseMetaData.getTables(Mockito.<String>any(), Mockito.<String>any(), Mockito.<String>any(),
        Mockito.<String[]>any())).thenThrow(new ActivitiException("An error occurred"));
    ...
    assertThrows(ActivitiException.class,
        () -> (new DbSqlSession(dbSqlSessionFactory, new EntityCacheImpl())).isTablePresent("Table Name"));
    verify(connection).getMetaData();
    verify(databaseMetaData).getTables(eq("postgres"), isNull(), eq("Table Name"), isA(String[].class));
    verify(transactionFactory).newTransaction(isA(DataSource.class), isNull(), eq(false));
  }
   ...
   * Test {@link DbSqlSession#isTablePresent(String)}.
   * <ul>
   *   <li>Given {@link DbSqlSessionFactory} (default constructor) DatabaseSchema is {@code postgres}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DbSqlSession#isTablePresent(String)}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean DbSqlSession.isTablePresent(String)"})
  public void testIsTablePresent_givenDbSqlSessionFactoryDatabaseSchemaIsPostgres() throws SQLException {
    // Arrange
    DatabaseMetaData databaseMetaData = mock(DatabaseMetaData.class);
    when(databaseMetaData.getTables(Mockito.<String>any(), Mockito.<String>any(), Mockito.<String>any(),
        Mockito.<String[]>any())).thenThrow(new ActivitiException("An error occurred"));
    ...
    assertThrows(ActivitiException.class,
        () -> (new DbSqlSession(dbSqlSessionFactory, new EntityCacheImpl())).isTablePresent("Table Name"));
    verify(connection).getMetaData();
    verify(databaseMetaData).getTables(isNull(), eq("postgres"), eq("Table Name"), isA(String[].class));
    verify(transactionFactory).newTransaction(isA(DataSource.class), isNull(), eq(false));
  }
   ...
   * Test {@link DbSqlSession#isTablePresent(String)}.
   * <ul>
   *   <li>Given {@link DbSqlSessionFactory} (default constructor) TablePrefixIsSchema is {@code true}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DbSqlSession#isTablePresent(String)}
   */
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean DbSqlSession.isTablePresent(String)"})
  public void testIsTablePresent_givenDbSqlSessionFactoryTablePrefixIsSchemaIsTrue() throws SQLException {
    // Arrange
    Connection connection = mock(Connection.class);
   ...
   * Test {@link DbSqlSession#isTablePresent(String)}.
   * <ul>
   *   <li>Given {@link ResultSet} {@link ResultSet#next()} throw {@link RuntimeException#RuntimeException(String)} with {@code postgres}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DbSqlSession#isTablePresent(String)}
   */
  ...
  public void testPrependDatabaseTablePrefix_thenReturnTableName() {
    ...
    assertEquals("Table Name",
        (new DbSqlSession(dbSqlSessionFactory, new EntityCacheImpl())).prependDatabaseTablePrefix("Table Name"));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link DbSqlSession#updateDdlForMySqlVersionLowerThan56(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  public void testUpdateDdlForMySqlVersionLowerThan56_thenReturnDdlStatements() {
    ...
    // Act and Assert
    assertEquals("Ddl Statements", (new DbSqlSession(dbSqlSessionFactory, new EntityCacheImpl()))
        .updateDdlForMySqlVersionLowerThan56("Ddl Statements"));
  }
