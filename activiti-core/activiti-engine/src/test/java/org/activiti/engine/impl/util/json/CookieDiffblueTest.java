...
public class CookieDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String Cookie.toString(JSONObject)"})
  public void testToStringWithJSONObject_givenValue_thenReturnTrueNull() throws JSONException {
    // Arrange
    JSONObject o = new JSONObject();
    o.append("value", JSONObject.NULL);
    o.put("name", true);

    // Act and Assert
    assertEquals("true=[null]", Cookie.toString(o));
  }
