...
public class GetExecutionVariablesCmdDiffblueTest {
   ...
   *
   * <p>Method under test: {@link GetExecutionVariablesCmd#GetExecutionVariablesCmd(String,
   * Collection, boolean)}
   */
  @Test
  ...
  public void testNewGetExecutionVariablesCmd() {
    // Arrange and Act
    GetExecutionVariablesCmd actualGetExecutionVariablesCmd =
        new GetExecutionVariablesCmd("42", new ArrayList<>(), true);
   ...
   * </ul>
   *
   * <p>Method under test: {@link GetExecutionVariablesCmd#getVariable(ExecutionEntity,
   * CommandContext)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.util.Map GetExecutionVariablesCmd.getVariable(ExecutionEntity, CommandContext)"
  })
  public void testGetVariable_thenReturnEmpty() {
    // Arrange
    GetExecutionVariablesCmd getExecutionVariablesCmd =
        new GetExecutionVariablesCmd("42", new ArrayList<>(), true);
  ...
  public void testGetVariable_thenReturnEmpty2() {
    // Arrange
    GetExecutionVariablesCmd getExecutionVariablesCmd =
        new GetExecutionVariablesCmd("42", new ArrayList<>(), false);
