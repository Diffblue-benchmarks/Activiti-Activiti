...
public class ProcessInstanceQueryImplDiffblueTest {
  /**
   * Test {@link ProcessInstanceQueryImpl#ProcessInstanceQueryImpl()}.
   *
   * <p>Method under test: {@link ProcessInstanceQueryImpl#ProcessInstanceQueryImpl()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessInstanceQueryImpl.<init>()"})
  public void testNewProcessInstanceQueryImpl() {
    // Arrange and Act
    ProcessInstanceQueryImpl actualProcessInstanceQueryImpl = new ProcessInstanceQueryImpl();

    // Assert
    assertEquals("RES.ID_ asc", actualProcessInstanceQueryImpl.getOrderBy());
    assertEquals("RES.ID_ asc", actualProcessInstanceQueryImpl.getOrderByColumns());
    assertEquals("TEMPRES_ID_ asc", actualProcessInstanceQueryImpl.getMssqlOrDB2OrderBy());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionVersion());
    assertNull(actualProcessInstanceQueryImpl.getProcessInstanceVariablesLimit());
    assertNull(actualProcessInstanceQueryImpl.getDatabaseType());
    assertNull(actualProcessInstanceQueryImpl.getActivityId());
    assertNull(actualProcessInstanceQueryImpl.getBusinessKey());
    assertNull(actualProcessInstanceQueryImpl.getDeploymentId());
    assertNull(actualProcessInstanceQueryImpl.getExecutionId());
    assertNull(actualProcessInstanceQueryImpl.getInvolvedUser());
    assertNull(actualProcessInstanceQueryImpl.getName());
    assertNull(actualProcessInstanceQueryImpl.getNameLike());
    assertNull(actualProcessInstanceQueryImpl.getNameLikeIgnoreCase());
    assertNull(actualProcessInstanceQueryImpl.getParentId());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionCategory());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionId());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionKey());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionName());
    assertNull(actualProcessInstanceQueryImpl.getProcessInstanceId());
    assertNull(actualProcessInstanceQueryImpl.getRootProcessInstanceId());
    assertNull(actualProcessInstanceQueryImpl.getStartedBy());
    assertNull(actualProcessInstanceQueryImpl.getSubProcessInstanceId());
    assertNull(actualProcessInstanceQueryImpl.getSuperProcessInstanceId());
    assertNull(actualProcessInstanceQueryImpl.getTenantId());
    assertNull(actualProcessInstanceQueryImpl.getTenantIdLike());
    assertNull(actualProcessInstanceQueryImpl.orderBy);
    assertNull(actualProcessInstanceQueryImpl.activityId);
    assertNull(actualProcessInstanceQueryImpl.locale);
    assertNull(actualProcessInstanceQueryImpl.getStartedAfter());
    assertNull(actualProcessInstanceQueryImpl.getStartedBefore());
    assertNull(actualProcessInstanceQueryImpl.getDeploymentIds());
    assertNull(actualProcessInstanceQueryImpl.getInvolvedGroups());
    assertNull(actualProcessInstanceQueryImpl.getEventSubscriptions());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionIds());
    assertNull(actualProcessInstanceQueryImpl.getProcessDefinitionKeys());
    assertNull(actualProcessInstanceQueryImpl.getProcessInstanceIds());
    assertNull(actualProcessInstanceQueryImpl.nullHandlingOnOrder);
    assertNull(actualProcessInstanceQueryImpl.resultType);
    assertNull(actualProcessInstanceQueryImpl.currentOrQueryObject);
    assertNull(actualProcessInstanceQueryImpl.commandContext);
    assertNull(actualProcessInstanceQueryImpl.commandExecutor);
    assertNull(actualProcessInstanceQueryImpl.getSuspensionState());
    assertNull(actualProcessInstanceQueryImpl.orderProperty);
    assertEquals(0, actualProcessInstanceQueryImpl.getFirstResult());
    assertEquals(1, actualProcessInstanceQueryImpl.getFirstRow());
    assertFalse(actualProcessInstanceQueryImpl.hasLocalQueryVariableValue());
    assertFalse(actualProcessInstanceQueryImpl.hasNonLocalQueryVariableValue());
    assertFalse(actualProcessInstanceQueryImpl.isExcludeSubprocesses());
    assertFalse(actualProcessInstanceQueryImpl.isIncludeChildExecutionsWithBusinessKeyQuery());
    assertFalse(actualProcessInstanceQueryImpl.isIncludeProcessVariables());
    assertFalse(actualProcessInstanceQueryImpl.isOnlyChildExecutions());
    assertFalse(actualProcessInstanceQueryImpl.isOnlyProcessInstanceExecutions());
    assertFalse(actualProcessInstanceQueryImpl.isOnlySubProcessExecutions());
    assertFalse(actualProcessInstanceQueryImpl.isWithoutTenantId());
    assertFalse(actualProcessInstanceQueryImpl.inOrStatement);
    assertFalse(actualProcessInstanceQueryImpl.withJobException);
    assertFalse(actualProcessInstanceQueryImpl.withLocalizationFallback);
    assertTrue(actualProcessInstanceQueryImpl.getQueryVariableValues().isEmpty());
    assertTrue(actualProcessInstanceQueryImpl.getOrQueryObjects().isEmpty());
    assertTrue(actualProcessInstanceQueryImpl.getOnlyProcessInstances());
    assertEquals(Integer.MAX_VALUE, actualProcessInstanceQueryImpl.getLastRow());
    assertEquals(Integer.MAX_VALUE, actualProcessInstanceQueryImpl.getMaxResults());
    Object actualParameter = actualProcessInstanceQueryImpl.getParameter();
    assertSame(actualProcessInstanceQueryImpl, actualParameter);
  }
