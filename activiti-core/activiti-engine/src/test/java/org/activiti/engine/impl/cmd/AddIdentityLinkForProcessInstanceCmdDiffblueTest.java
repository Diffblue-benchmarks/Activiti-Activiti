...
public class AddIdentityLinkForProcessInstanceCmdDiffblueTest {
    ...
    assertThrows(
        ...
        () ->
            new AddIdentityLinkForProcessInstanceCmd(
                null, null, null, null, new byte[] {'A', 'X', 'A', 'X', 'A', 'X', 'A', 'X'}));
  }
  ...
  public void testNewAddIdentityLinkForProcessInstanceCmd5() {
    ...
    assertThrows(
        ...
        () ->
            new AddIdentityLinkForProcessInstanceCmd(
                "42", null, null, null, new byte[] {'A', 'X', 'A', 'X', 'A', 'X', 'A', 'X'}));
  }
  ...
  public void testValidateParams_when42_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> addIdentityLinkForProcessInstanceCmd.validateParams("42", null, null, null));
  }
  ...
  public void testValidateParams_whenNull_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> addIdentityLinkForProcessInstanceCmd.validateParams(null, null, null, null));
  }
