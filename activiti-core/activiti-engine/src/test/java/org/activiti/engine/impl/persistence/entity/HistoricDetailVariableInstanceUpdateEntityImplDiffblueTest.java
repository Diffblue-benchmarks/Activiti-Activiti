...
public class HistoricDetailVariableInstanceUpdateEntityImplDiffblueTest {
  ...
  public void testGetValue5() {
    ...
    HistoricDetailVariableInstanceUpdateEntityImpl historicDetailVariableInstanceUpdateEntityImpl =
        new HistoricDetailVariableInstanceUpdateEntityImpl();
    historicDetailVariableInstanceUpdateEntityImpl.setVariableType(new JPAEntityListVariableType());
   ...
   *
   * <ul>
   *   <li>Given {@link HistoricDetailVariableInstanceUpdateEntityImpl} (default constructor) Bytes
   *       is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link HistoricDetailVariableInstanceUpdateEntityImpl#setBytes(byte[])}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void HistoricDetailVariableInstanceUpdateEntityImpl.setBytes(byte[])"})
  public void testSetBytes_givenHistoricDetailVariableInstanceUpdateEntityImplBytesIsNull() {
    // Arrange
    HistoricDetailVariableInstanceUpdateEntityImpl historicDetailVariableInstanceUpdateEntityImpl =
        new HistoricDetailVariableInstanceUpdateEntityImpl();
    historicDetailVariableInstanceUpdateEntityImpl.setActivityInstanceId("42");
  ...
  public void testToString2() {
    ...
    // Act and Assert
    assertEquals(
        "HistoricDetailVariableInstanceUpdateEntity[id=42, name=Name, type=null]",
  ...
  public void testToString3() {
    ...
    // Act and Assert
    assertEquals(
        "HistoricDetailVariableInstanceUpdateEntity[id=42, name=Name, type=null, textValue2=]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
  ...
  public void testToString4() {
    ...
    // Act and Assert
    assertEquals(
        "HistoricDetailVariableInstanceUpdateEntity[id=42, name=Name, type=null, textValue=HistoricDetailVari"
            + "ableInstanceUpdateE...]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String HistoricDetailVariableInstanceUpdateEntityImpl.toString()"})
  public void testToString_givenHistoricDetailVariableInstanceUpdateEntityImplDoubleValueIsTen() {
    // Arrange
    HistoricDetailVariableInstanceUpdateEntityImpl historicDetailVariableInstanceUpdateEntityImpl =
        new HistoricDetailVariableInstanceUpdateEntityImpl();
    historicDetailVariableInstanceUpdateEntityImpl.setActivityInstanceId("42");
