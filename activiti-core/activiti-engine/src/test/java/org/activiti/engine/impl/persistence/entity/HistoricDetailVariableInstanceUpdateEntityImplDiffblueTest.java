...
public class HistoricDetailVariableInstanceUpdateEntityImplDiffblueTest {
  ...
  public void testToString3() {
    ...
    // Act and Assert
    assertEquals("HistoricDetailVariableInstanceUpdateEntity[id=42, name=Name, type=null, textValue2=not empty]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
  ...
  public void testToString4() {
    ...
    // Act and Assert
    assertEquals("HistoricDetailVariableInstanceUpdateEntity[id=42, name=Name, type=null, textValue2=]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
  ...
  public void testToString5() {
    ...
    // Act and Assert
    assertEquals("HistoricDetailVariableInstanceUpdateEntity[id=42, name=Name, type=null, textValue=not empty]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
  ...
  public void testToString7() {
    ...
    // Act and Assert
    assertEquals("HistoricDetailVariableInstanceUpdateEntity[id=null, name=null, type=null, longValue=42]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
  ...
  public void testToString8() {
    ...
    // Act and Assert
    assertEquals("HistoricDetailVariableInstanceUpdateEntity[id=null, name=null, type=null, doubleValue=10.0]",
        historicDetailVariableInstanceUpdateEntityImpl.toString());
  }
}
