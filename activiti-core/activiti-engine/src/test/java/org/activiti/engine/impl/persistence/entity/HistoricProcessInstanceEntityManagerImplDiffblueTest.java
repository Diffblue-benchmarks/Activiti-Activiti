...
public class HistoricProcessInstanceEntityManagerImplDiffblueTest {
   ...
   */
  @Test
  public void testFindHistoricProcessInstanceCountByQueryCriteria() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
   ...
   */
  @Test
  public void testFindHistoricProcessInstancesByQueryCriteria() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    processEngineConfiguration
        .setHistoryManager(new DefaultHistoryManager(new JtaProcessEngineConfiguration(), HistoryLevel.NONE));
   ...
   */
  @Test
  public void testFindHistoricProcessInstancesAndVariablesByQueryCriteria() {
    // Arrange
    JtaProcessEngineConfiguration processEngineConfiguration = new JtaProcessEngineConfiguration();
    processEngineConfiguration
        .setHistoryManager(new DefaultHistoryManager(new JtaProcessEngineConfiguration(), HistoryLevel.NONE));
   ...
   */
  @Test
  public void testFindHistoricProcessInstancesByNativeQuery() {
    // Arrange
    ...
    when(historicProcessInstanceDataManager
        ...
        .thenReturn(historicProcessInstanceList);
    HistoricProcessInstanceEntityManagerImpl historicProcessInstanceEntityManagerImpl = new HistoricProcessInstanceEntityManagerImpl(
    ...
    assertSame(historicProcessInstanceList, actualFindHistoricProcessInstancesByNativeQueryResult);
  }
   ...
   */
  @Test
  public void testFindHistoricProcessInstanceCountByNativeQuery() {
    // Arrange
    HistoricProcessInstanceDataManager historicProcessInstanceDataManager = mock(
        HistoricProcessInstanceDataManager.class);
    when(historicProcessInstanceDataManager
