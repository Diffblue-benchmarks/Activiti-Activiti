...
public class InactiveExecutionsByProcInstMatcherDiffblueTest {
  /**
   * Test {@link InactiveExecutionsByProcInstMatcher#isRetained(ExecutionEntity, Object)} with {@code ExecutionEntity}, {@code Object}.
   * <ul>
   *   <li>Given {@code 42}.</li>
   * </ul>
   * <p>
   * Method under test: {@link InactiveExecutionsByProcInstMatcher#isRetained(ExecutionEntity, Object)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean InactiveExecutionsByProcInstMatcher.isRetained(ExecutionEntity, Object)"})
  public void testIsRetainedWithExecutionEntityObject_given42() {
    // Arrange
    InactiveExecutionsByProcInstMatcher inactiveExecutionsByProcInstMatcher = new InactiveExecutionsByProcInstMatcher();
    ...
    // Act
    boolean actualIsRetainedResult = inactiveExecutionsByProcInstMatcher.isRetained(executionEntity, new HashMap<>());
