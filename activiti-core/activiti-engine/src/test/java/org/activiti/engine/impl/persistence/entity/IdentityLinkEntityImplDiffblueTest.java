...
public class IdentityLinkEntityImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link IdentityLinkEntityImpl} (default constructor) UserId is {@code foo}.
  ...
  public void testToString_givenIdentityLinkEntityImplUserIdIsFoo_thenReturnAString()
    ...
    // Act and Assert
    assertEquals(
        "IdentityLinkEntity[id=42, type=Type, userId=foo, taskId=foo, processInstanceId=foo, processDefId=foo,"
            + " details=AXAXAXAX]",
   ...
   *
   * <ul>
   *   <li>Given {@link IdentityLinkEntityImpl} (default constructor) UserId is {@code null}.
   *   <li>Then return a string.
   * </ul>
   *
   * <p>Method under test: {@link IdentityLinkEntityImpl#toString()}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String IdentityLinkEntityImpl.toString()"})
  public void testToString_givenIdentityLinkEntityImplUserIdIsNull_thenReturnAString()
      throws UnsupportedEncodingException {
    // Arrange
    IdentityLinkEntityImpl identityLinkEntityImpl = new IdentityLinkEntityImpl();
    identityLinkEntityImpl.setDeleted(true);
    ...
    // Act and Assert
    assertEquals(
        "IdentityLinkEntity[id=42, type=Type, groupId=foo, taskId=foo, processInstanceId=foo, processDefId=foo,"
            + " details=AXAXAXAX]",
        identityLinkEntityImpl.toString());
  }
