...
public class AbstractDatabaseEventLoggerEventHandlerDiffblueTest {
   ...
   */
  @Test
  public void testSetObjectMapper2() {
    // Arrange
    ActivityCompensatedEventHandler activityCompensatedEventHandler = new ActivityCompensatedEventHandler();
   ...
   */
  @Test
  public void testGetEntityFromEvent() {
    // Arrange
    ActivityCompensatedEventHandler activityCompensatedEventHandler = new ActivityCompensatedEventHandler();
   ...
   */
  @Test
  public void testPutInMapIfNotNull() {
    // Arrange
   ...
   */
  @Test
  public void testPutInMapIfNotNull2() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
   ...
   */
  @Test
  public void testPutInMapIfNotNull3() {
    // Arrange
    HashMap<String, Object> map = new HashMap<>();
