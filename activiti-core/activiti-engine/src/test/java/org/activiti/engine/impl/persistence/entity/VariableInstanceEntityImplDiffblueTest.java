...
public class VariableInstanceEntityImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void VariableInstanceEntityImpl.setBytes(byte[])"})
  public void testSetBytes_thenVariableInstanceEntityImplByteArrayRefNameIsVarNull2() {
    // Arrange
    VariableInstanceEntityImpl variableInstanceEntityImpl = new VariableInstanceEntityImpl();
    variableInstanceEntityImpl.setBytes(null);
  ...
  public void testGetValue_givenJPAEntityListVariableTypeForceCacheableIsFalse_thenReturnNull() {
    ...
    VariableInstanceEntityImpl variableInstanceEntityImpl = new VariableInstanceEntityImpl();
    variableInstanceEntityImpl.setType(type);
    variableInstanceEntityImpl.setCachedValue(JSONObject.NULL);
   ...
   *
   * <ul>
   *   <li>Given {@link VariableInstanceEntityImpl} (default constructor) TextValue2 is empty
   *       string.
   * </ul>
   *
  ...
  public void testToString_givenVariableInstanceEntityImplTextValue2IsEmptyString() {
    // Arrange
    VariableInstanceEntityImpl variableInstanceEntityImpl = new VariableInstanceEntityImpl();
    variableInstanceEntityImpl.setType(new BigDecimalType());
    variableInstanceEntityImpl.setLongValue(1L);
    ...
    // Act and Assert
    assertEquals(
        "VariableInstanceEntity[id=null, name=null, type=bigdecimal, longValue=1, doubleValue=10.0, textValue=not"
            + " empty, textValue2=]",
   ...
   *
   * <ul>
   *   <li>Given {@link VariableInstanceEntityImpl} (default constructor) TextValue2 is {@code not
   *       empty}.
   * </ul>
   *
   * <p>Method under test: {@link VariableInstanceEntityImpl#toString()}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String VariableInstanceEntityImpl.toString()"})
  public void testToString_givenVariableInstanceEntityImplTextValue2IsNotEmpty() {
    // Arrange
    VariableInstanceEntityImpl variableInstanceEntityImpl = new VariableInstanceEntityImpl();
    variableInstanceEntityImpl.setType(new BigDecimalType());
    variableInstanceEntityImpl.setLongValue(1L);
