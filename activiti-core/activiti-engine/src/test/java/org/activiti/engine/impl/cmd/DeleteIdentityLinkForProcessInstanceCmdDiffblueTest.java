...
public class DeleteIdentityLinkForProcessInstanceCmdDiffblueTest {
  ...
  public void testValidateParams_whenNull_thenDoesNotThrow() {
    ...
    // Act and Assert
    deleteIdentityLinkForProcessInstanceCmd.validateParams(null, "42", "42", "Type");
  }
  ...
  public void testValidateParams_whenNull_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> deleteIdentityLinkForProcessInstanceCmd.validateParams("42", "42", "42", null));
  }
  ...
  public void testValidateParams_whenNull_thenThrowActivitiIllegalArgumentException2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> deleteIdentityLinkForProcessInstanceCmd.validateParams("42", "42", null, "Type"));
  }
  ...
  public void testValidateParams_whenType_thenDoesNotThrow() {
    ...
    // Act and Assert
    deleteIdentityLinkForProcessInstanceCmd.validateParams("42", "42", "42", "Type");
  }
}
