...
public class DefaultActivityBehaviorFactoryDiffblueTest {
   ...
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#DefaultActivityBehaviorFactory()}
   */
  @Test
  ...
  public void testNewDefaultActivityBehaviorFactory() {
    // Arrange and Act
    DefaultActivityBehaviorFactory actualDefaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory();

    // Assert
    assertTrue(
        actualDefaultActivityBehaviorFactory.getMessageExecutionContextFactory()
            instanceof DefaultMessageExecutionContextFactory);
    assertTrue(
        actualDefaultActivityBehaviorFactory.getMessagePayloadMappingProviderFactory()
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#DefaultActivityBehaviorFactory(ClassDelegateFactory)}.
   *
   ...
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#createTaskActivityBehavior(Task)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createManualTaskActivityBehavior(ManualTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createReceiveTaskActivityBehavior(ReceiveTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createUserTaskActivityBehavior(UserTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#getSkipExpressionFromServiceTask(ServiceTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Expression DefaultActivityBehaviorFactory.getSkipExpressionFromServiceTask(ServiceTask)"
  })
  public void testGetSkipExpressionFromServiceTask() {
    ...
    // Act
    Expression actualSkipExpressionFromServiceTask =
        defaultActivityBehaviorFactory.getSkipExpressionFromServiceTask(serviceTask);
  ...
  public void testGetSkipExpressionFromServiceTask_thenReturnFixedValue() {
    ...
    when(serviceTask.getSkipExpression()).thenReturn("not empty");
   ...
   *
   * <ul>
   *   <li>Then return {@link JuelExpression}.
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#getSkipExpressionFromServiceTask(ServiceTask)}
  ...
  public void testGetSkipExpressionFromServiceTask_thenReturnJuelExpression() {
    // Arrange
    ExpressionManager expressionManager = new ExpressionManager(true);
    expressionManager.setCustomFunctionProviders(new ArrayList<>());
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createClassDelegateServiceTask(ServiceTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ClassDelegate DefaultActivityBehaviorFactory.createClassDelegateServiceTask(ServiceTask)"
  })
  ...
  public void testCreateClassDelegateServiceTask6() {
    ...
    when(classDelegateFactory.create(
            Mockito.<String>any(),
            Mockito.<String>any(),
            Mockito.<List<FieldDeclaration>>any(),
            Mockito.<Expression>any(),
            Mockito.<List<MapExceptionEntry>>any()))
        .thenReturn(classDelegate);

    DefaultActivityBehaviorFactory defaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory(classDelegateFactory);
    defaultActivityBehaviorFactory.setExpressionManager(expressionManager);
    ...
    verify(serviceTask, atLeast(1)).getSkipExpression();
    verify(serviceTask).getFieldExtensions();
    verify(classDelegateFactory)
        .create(
            eq("42"),
            eq("Implementation"),
            isA(List.class),
            isA(Expression.class),
            isA(List.class));
    verify(expressionManager, atLeast(1)).createExpression(Mockito.<String>any());
  ...
  public void testCreateClassDelegateServiceTask8() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doThrow(new ActivitiException("An error occurred"))
        .when(customFunctionProvider)
  ...
  public void testCreateClassDelegateServiceTask9() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doNothing().when(customFunctionProvider).addCustomFunctions(Mockito.<ActivitiElContext>any());
  ...
  public void testCreateClassDelegateServiceTask_whenServiceTask() {
    ...
    // Act
    ClassDelegate actualCreateClassDelegateServiceTaskResult =
        defaultActivityBehaviorFactory.createClassDelegateServiceTask(new ServiceTask());
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createServiceTaskDelegateExpressionActivityBehavior(ServiceTask)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createServiceTaskDelegateExpressionActivityBehavior(ServiceTask)}
   */
  ...
  public void testCreateServiceTaskDelegateExpressionActivityBehavior() {
    ...
    ServiceTaskDelegateExpressionActivityBehavior
        actualCreateServiceTaskDelegateExpressionActivityBehaviorResult =
            defaultActivityBehaviorFactory.createServiceTaskDelegateExpressionActivityBehavior(
                serviceTask);
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createDefaultServiceTaskBehavior(ServiceTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ActivityBehavior DefaultActivityBehaviorFactory.createDefaultServiceTaskBehavior(ServiceTask)"
  })
  public void testCreateDefaultServiceTaskBehavior() {
    ...
    // Act
    ActivityBehavior actualCreateDefaultServiceTaskBehaviorResult =
        defaultActivityBehaviorFactory.createDefaultServiceTaskBehavior(serviceTask);

    // Assert
    assertTrue(
        actualCreateDefaultServiceTaskBehaviorResult
            instanceof ServiceTaskDelegateExpressionActivityBehavior);
    assertNull(
        ((ServiceTaskDelegateExpressionActivityBehavior)
                actualCreateDefaultServiceTaskBehaviorResult)
            .getMultiInstanceActivityBehavior());
  ...
  public void testCreateDefaultServiceTaskBehavior3() {
    ...
    // Assert
    verify(customFunctionProvider, atLeast(1)).addCustomFunctions(Mockito.<ActivitiElContext>any());
    assertTrue(
        actualCreateDefaultServiceTaskBehaviorResult
            instanceof ServiceTaskDelegateExpressionActivityBehavior);
    assertNull(
  ...
  public void testCreateDefaultServiceTaskBehavior5() {
    ...
    // Assert
    verify(customFunctionProvider2, atLeast(1))
        .addCustomFunctions(Mockito.<ActivitiElContext>any());
    verify(customFunctionProvider, atLeast(1)).addCustomFunctions(Mockito.<ActivitiElContext>any());
    assertTrue(
        actualCreateDefaultServiceTaskBehaviorResult
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createServiceTaskExpressionActivityBehavior(ServiceTask)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createServiceTaskExpressionActivityBehavior(ServiceTask)}
   */
  ...
  public void testCreateServiceTaskExpressionActivityBehavior() {
    ...
    // Act
    ServiceTaskExpressionActivityBehavior actualCreateServiceTaskExpressionActivityBehaviorResult =
        defaultActivityBehaviorFactory.createServiceTaskExpressionActivityBehavior(serviceTask);
    ...
    verify(expressionManager).setCustomFunctionProviders(isA(List.class));
    assertNull(
        actualCreateServiceTaskExpressionActivityBehaviorResult.getMultiInstanceActivityBehavior());
  }
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createWebServiceActivityBehavior(SendTask)} with
   * {@code sendTask}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createWebServiceActivityBehavior(SendTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createWebServiceActivityBehavior(ServiceTask)} with
   * {@code serviceTask}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createWebServiceActivityBehavior(ServiceTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createMailActivityBehavior(SendTask)} with {@code
   * sendTask}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createMailActivityBehavior(SendTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createMailActivityBehavior(ServiceTask)} with {@code
   * serviceTask}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createMailActivityBehavior(ServiceTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createMailActivityBehavior(String, List)} with
   * {@code taskId}, {@code fields}.
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#createMailActivityBehavior(String,
   * List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateMailActivityBehaviorWithTaskIdFields() {
    ...
    assertNull(
        defaultActivityBehaviorFactory
            .createMailActivityBehavior("42", new ArrayList<>())
            .getMultiInstanceActivityBehavior());
  }
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createShellActivityBehavior(ServiceTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ShellActivityBehavior DefaultActivityBehaviorFactory.createShellActivityBehavior(ServiceTask)"
  })
  public void testCreateShellActivityBehavior_thenCallsCreateExpression() {
    // Arrange
    ExpressionManager expressionManager = mock(ExpressionManager.class);
    when(expressionManager.createExpression(Mockito.<String>any()))
        .thenReturn(new FixedValue(JSONObject.NULL));
    ...
    // Act
    ShellActivityBehavior actualCreateShellActivityBehaviorResult =
        defaultActivityBehaviorFactory.createShellActivityBehavior(serviceTask);
  ...
  public void testCreateShellActivityBehavior_thenCallsGetStringValue() {
    // Arrange
    DefaultActivityBehaviorFactory defaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory();
    defaultActivityBehaviorFactory.setExpressionManager(mock(ExpressionManager.class));
   ...
   *
   * <ul>
   *   <li>Given {@code Script Task}.
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createScriptTaskActivityBehavior(ScriptTask)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>When {@link ScriptTask} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createScriptTaskActivityBehavior(ScriptTask)}
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createSequentialMultiInstanceBehavior(Activity,
   * AbstractBpmnActivityBehavior)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createSequentialMultiInstanceBehavior(Activity,
   * AbstractBpmnActivityBehavior)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateSequentialMultiInstanceBehavior() {
    ...
    SequentialMultiInstanceBehavior actualCreateSequentialMultiInstanceBehaviorResult =
        defaultActivityBehaviorFactory.createSequentialMultiInstanceBehavior(
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createParallelMultiInstanceBehavior(Activity,
   * AbstractBpmnActivityBehavior)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createParallelMultiInstanceBehavior(Activity,
   * AbstractBpmnActivityBehavior)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateParallelMultiInstanceBehavior() {
    ...
    ParallelMultiInstanceBehavior actualCreateParallelMultiInstanceBehaviorResult =
        defaultActivityBehaviorFactory.createParallelMultiInstanceBehavior(
            activity, innerActivityBehavior);
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createSubprocessActivityBehavior(SubProcess)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createEventSubProcessErrorStartEventActivityBehavior(StartEvent)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createEventSubProcessErrorStartEventActivityBehavior(StartEvent)}
   */
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createEventSubProcessMessageStartEventActivityBehavior(StartEvent,
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior2() {
    ...
    when(messageExecutionContextFactory.create(
            Mockito.<MessageEventDefinition>any(),
            Mockito.<MessagePayloadMappingProvider>any(),
    ...
    assertThrows(
        ...
        () ->
            defaultActivityBehaviorFactory.createEventSubProcessMessageStartEventActivityBehavior(
                startEvent, new MessageEventDefinition()));
    verify(messageExecutionContextFactory)
        .create(
            isA(MessageEventDefinition.class), isA(MessagePayloadMappingProvider.class), isNull());
  }
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior5() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
    ...
    verify(messageExecutionContextFactory)
        .create(
            isA(MessageEventDefinition.class),
            isA(MessagePayloadMappingProvider.class),
            isA(ExpressionManager.class));
  }
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior6() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior7() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior8() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior9() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateEventSubProcessMessageStartEventActivityBehavior10() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createAdhocSubprocessActivityBehavior(SubProcess)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createCallActivityBehavior(CallActivity)} with
   * {@code callActivity}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createCallActivityBehavior(CallActivity)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CallActivityBehavior DefaultActivityBehaviorFactory.createCallActivityBehavior(CallActivity)"
  })
  ...
  public void testCreateCallActivityBehaviorWithCallActivity4() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doThrow(new ActivitiException("An error occurred"))
        .when(customFunctionProvider)
  ...
  public void testCreateCallActivityBehaviorWithCallActivity5() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doNothing().when(customFunctionProvider).addCustomFunctions(Mockito.<ActivitiElContext>any());
  ...
  public void testCreateCallActivityBehaviorWithCallActivity_givenUU() {
    ...
    // Assert
    verify(expressionManager).createExpression("${U}${U}");
    verify(expressionManager).setCustomFunctionProviders(isA(List.class));
    assertNull(actualCreateCallActivityBehaviorResult.getProcessDefinitionKey());
    assertNull(actualCreateCallActivityBehaviorResult.getMultiInstanceActivityBehavior());
  }
  ...
  public void testCreateCallActivityBehaviorWithCallActivity_thenCallsCreateExpression() {
    // Arrange
    ArrayList<CustomFunctionProvider> customFunctionProviders = new ArrayList<>();
    customFunctionProviders.add(mock(CustomFunctionProvider.class));
    customFunctionProviders.add(mock(CustomFunctionProvider.class));
  ...
  public void testCreateCallActivityBehaviorWithCallActivity_whenCallActivity() {
    ...
    // Act
    CallActivityBehavior actualCreateCallActivityBehaviorResult =
        defaultActivityBehaviorFactory.createCallActivityBehavior(new CallActivity());
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createCallActivityBehavior(String, List)} with
   * {@code calledElement}, {@code mapExceptions}.
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#createCallActivityBehavior(String,
   * List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "CallActivityBehavior DefaultActivityBehaviorFactory.createCallActivityBehavior(String, List)"
  })
  public void testCreateCallActivityBehaviorWithCalledElementMapExceptions() {
    ...
    // Act
    CallActivityBehavior actualCreateCallActivityBehaviorResult =
        defaultActivityBehaviorFactory.createCallActivityBehavior("Called Element", mapExceptions);
  ...
  public void testCreateCallActivityBehaviorWithCalledElementMapExceptions_whenArrayList() {
    ...
    // Act
    CallActivityBehavior actualCreateCallActivityBehaviorResult =
        defaultActivityBehaviorFactory.createCallActivityBehavior(
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createCallActivityBehavior(Expression, List)} with
   * {@code expression}, {@code mapExceptions}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createCallActivityBehavior(Expression, List)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreateCallActivityBehaviorWithExpressionMapExceptions() {
    ...
    // Act
    CallActivityBehavior actualCreateCallActivityBehaviorResult =
        defaultActivityBehaviorFactory.createCallActivityBehavior(expression, mapExceptions);
  ...
  public void testCreateCallActivityBehaviorWithExpressionMapExceptions_whenArrayList() {
    ...
    // Act
    CallActivityBehavior actualCreateCallActivityBehaviorResult =
        defaultActivityBehaviorFactory.createCallActivityBehavior(expression, new ArrayList<>());
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createTransactionActivityBehavior(Transaction)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createIntermediateCatchEventActivityBehavior(IntermediateCatchEvent)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createIntermediateCatchEventActivityBehavior(IntermediateCatchEvent)}
   */
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createIntermediateCatchMessageEventActivityBehavior(IntermediateCatchEvent,
   * MessageEventDefinition)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createIntermediateCatchMessageEventActivityBehavior(IntermediateCatchEvent,
  ...
  public void testCreateIntermediateCatchMessageEventActivityBehavior() {
    ...
    IntermediateCatchMessageEventActivityBehavior
        actualCreateIntermediateCatchMessageEventActivityBehaviorResult =
            defaultActivityBehaviorFactory.createIntermediateCatchMessageEventActivityBehavior(
  ...
  public void testCreateIntermediateCatchMessageEventActivityBehavior2() {
    ...
    assertThrows(
        ...
        () ->
            defaultActivityBehaviorFactory.createIntermediateCatchMessageEventActivityBehavior(
                intermediateCatchEvent, new MessageEventDefinition()));
    verify(messageExecutionContextFactory)
        .create(
            isA(MessageEventDefinition.class), isA(MessagePayloadMappingProvider.class), isNull());
  }
  ...
  public void testCreateIntermediateCatchMessageEventActivityBehavior6() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateIntermediateCatchMessageEventActivityBehavior7() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateIntermediateCatchMessageEventActivityBehavior8() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateIntermediateCatchMessageEventActivityBehavior_thenCallsGetStringValue() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createIntermediateCatchTimerEventActivityBehavior(IntermediateCatchEvent,
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createIntermediateCatchSignalEventActivityBehavior(IntermediateCatchEvent,
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createIntermediateThrowSignalEventActivityBehavior(ThrowEvent,
   * SignalEventDefinition, Signal)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createIntermediateThrowSignalEventActivityBehavior(ThrowEvent,
  ...
  public void testCreateIntermediateThrowSignalEventActivityBehavior2() {
    ...
    assertThrows(
        ActivitiException.class,
        () ->
            defaultActivityBehaviorFactory.createIntermediateThrowSignalEventActivityBehavior(
                throwEvent, signalEventDefinition, signal));
  ...
  public void testCreateIntermediateThrowSignalEventActivityBehavior_givenEmptyString() {
    ...
    assertNull(
        defaultActivityBehaviorFactory
            .createIntermediateThrowSignalEventActivityBehavior(
                throwEvent, signalEventDefinition, null)
            .getMultiInstanceActivityBehavior());
  }
  ...
  public void testCreateIntermediateThrowSignalEventActivityBehavior_whenSignal() {
    // Arrange
    DefaultActivityBehaviorFactory defaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory();
    ThrowEvent throwEvent = new ThrowEvent();
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createErrorEndEventActivityBehavior(EndEvent,
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createErrorEndEventActivityBehavior(EndEvent,
   * ErrorEventDefinition)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateTerminateEndEventActivityBehavior_thenThrowActivitiException() {
    ...
    when(terminateEventDefinition.isTerminateAll())
        .thenThrow(new ActivitiException("An error occurred"));
   ...
   *
   * <ul>
   *   <li>When {@link EndEvent} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createTerminateEndEventActivityBehavior(EndEvent)}
  ...
  public void testCreateTerminateEndEventActivityBehavior_whenEndEvent() {
    ...
    // Act
    TerminateEndEventActivityBehavior actualCreateTerminateEndEventActivityBehaviorResult =
        defaultActivityBehaviorFactory.createTerminateEndEventActivityBehavior(new EndEvent());
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createBoundaryEventActivityBehavior(BoundaryEvent,
   * boolean)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createBoundaryEventActivityBehavior(BoundaryEvent, boolean)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createBoundaryCancelEventActivityBehavior(CancelEventDefinition)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createBoundaryCancelEventActivityBehavior(CancelEventDefinition)}
   */
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createBoundaryCompensateEventActivityBehavior(BoundaryEvent,
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createBoundaryTimerEventActivityBehavior(BoundaryEvent,
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createBoundarySignalEventActivityBehavior(BoundaryEvent,
  ...
  /**
   * Test {@link
   * DefaultActivityBehaviorFactory#createBoundaryMessageEventActivityBehavior(BoundaryEvent,
  ...
  public void testCreateBoundaryMessageEventActivityBehavior() {
    ...
    BoundaryMessageEventActivityBehavior actualCreateBoundaryMessageEventActivityBehaviorResult =
        defaultActivityBehaviorFactory.createBoundaryMessageEventActivityBehavior(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior3() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior4() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior5() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior_givenArrayListAddFieldExtension() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior_givenArrayListAddFieldExtension2() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior_thenCallsGetExpression() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior_thenCallsGetStringValue() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateBoundaryMessageEventActivityBehavior_whenMessageEventDefinition() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
    ...
    assertThrows(
        ...
        () ->
            defaultActivityBehaviorFactory.createBoundaryMessageEventActivityBehavior(
                boundaryEvent, new MessageEventDefinition(), true));
    verify(messageExecutionContextFactory)
        .create(
            isA(MessageEventDefinition.class), isA(MessagePayloadMappingProvider.class), isNull());
  }
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createThrowMessageEventActivityBehavior(ThrowEvent,
   * MessageEventDefinition, Message)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createThrowMessageEventActivityBehavior(ThrowEvent,
   * MessageEventDefinition, Message)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateThrowMessageEventActivityBehavior() {
    ...
    IntermediateThrowMessageEventActivityBehavior
        actualCreateThrowMessageEventActivityBehaviorResult =
            defaultActivityBehaviorFactory.createThrowMessageEventActivityBehavior(
                throwEvent,
                messageEventDefinition,
                attributesResult
  ...
  public void testCreateThrowMessageEventActivityBehavior2() {
    ...
    DefaultActivityBehaviorFactory defaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory();
    defaultActivityBehaviorFactory.setThrowMessageDelegateFactory(
    ...
    assertTrue(
        actualCreateThrowMessageEventActivityBehaviorResult.getDelegate()
            instanceof TestThrowMessageDelegate);
    assertSame(
        messageEventDefinition,
        actualCreateThrowMessageEventActivityBehaviorResult.getMessageEventDefinition());
    assertSame(throwEvent, actualCreateThrowMessageEventActivityBehaviorResult.getThrowEvent());
  ...
  public void testCreateThrowMessageEventActivityBehavior_thenThrowActivitiException() {
    ...
    when(messagePayloadMappingProviderFactory.create(
            Mockito.<Event>any(),
            Mockito.<MessageEventDefinition>any(),
            Mockito.<ExpressionManager>any()))
        .thenThrow(new ActivitiException("An error occurred"));
        ...
        () ->
            defaultActivityBehaviorFactory.createThrowMessageEventActivityBehavior(
                ...
                attributesResult
                    ...
                    .xmlRowNumber(10)
                    .build()));
    verify(messagePayloadMappingProviderFactory)
        .create(isA(Event.class), isA(MessageEventDefinition.class), isNull());
  }

  /**
   * Test {@link DefaultActivityBehaviorFactory#createThrowMessageEndEventActivityBehavior(EndEvent,
   * MessageEventDefinition, Message)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createThrowMessageEndEventActivityBehavior(EndEvent,
   * MessageEventDefinition, Message)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateThrowMessageEndEventActivityBehavior() {
    ...
    ThrowMessageEndEventActivityBehavior actualCreateThrowMessageEndEventActivityBehaviorResult =
        defaultActivityBehaviorFactory.createThrowMessageEndEventActivityBehavior(
            endEvent,
            messageEventDefinition,
            attributesResult
                .extensionElements(new HashMap<>())
   ...
   *
   * <ul>
   *   <li>Then return {@link DefaultThrowMessageJavaDelegate}.
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createThrowMessageDelegate(MessageEventDefinition)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreateThrowMessageDelegate_thenReturnDefaultThrowMessageJavaDelegate() {
    ...
    // Act and Assert
    assertTrue(
        defaultActivityBehaviorFactory.createThrowMessageDelegate(new MessageEventDefinition())
            instanceof DefaultThrowMessageJavaDelegate);
  }
   ...
   *
   * <ul>
   *   <li>Then return {@link MessageThrowCatchEventTest.TestThrowMessageDelegate}.
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createThrowMessageDelegate(MessageEventDefinition)}
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createMessageExecutionContext(Event,
   * MessageEventDefinition)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createMessageExecutionContext(Event, MessageEventDefinition)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreateMessageExecutionContext() {
    ...
    assertThrows(
        ActivitiException.class,
        () ->
            defaultActivityBehaviorFactory.createMessageExecutionContext(
                bpmnEvent, messageEventDefinition));
    verify(fieldExtension, atLeast(1)).getExpression();
    verify(fieldExtension).getFieldName();
    verify(messageExecutionContextFactory)
        .create(
  ...
  public void testCreateMessageExecutionContext3() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateMessageExecutionContext4() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateMessageExecutionContext5() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateMessageExecutionContext_givenArrayListAddFieldExtension() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateMessageExecutionContext_givenArrayListAddFieldExtension2() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
  ...
  public void testCreateMessageExecutionContext_thenCallsGetStringValue() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
   ...
   *
   * <ul>
   *   <li>Then return {@link DefaultMessageExecutionContext}.
   * </ul>
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createMessageExecutionContext(Event, MessageEventDefinition)}
  ...
  public void testCreateMessageExecutionContext_thenReturnDefaultMessageExecutionContext() {
    ...
    // Act
    MessageExecutionContext actualCreateMessageExecutionContextResult =
        defaultActivityBehaviorFactory.createMessageExecutionContext(
            bpmnEvent, new MessageEventDefinition());

    // Assert
    assertTrue(actualCreateMessageExecutionContextResult instanceof DefaultMessageExecutionContext);
    assertTrue(
        ((DefaultMessageExecutionContext) actualCreateMessageExecutionContextResult)
                .getMessagePayloadMappingProvider()
            instanceof BpmnMessagePayloadMappingProvider);
    assertNull(
        ((DefaultMessageExecutionContext) actualCreateMessageExecutionContextResult)
  ...
  public void testCreateMessageExecutionContext_whenMessageEventDefinition() {
    // Arrange
    MessageExecutionContextFactory messageExecutionContextFactory =
        mock(MessageExecutionContextFactory.class);
    when(messageExecutionContextFactory.create(
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createThrowMessageDelegateExpression(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreateThrowMessageDelegateExpression() {
    ...
    // Act and Assert
    assertTrue(
        defaultActivityBehaviorFactory.createThrowMessageDelegateExpression("Delegate Expression")
            instanceof ThrowMessageDelegateExpression);
  }
  ...
  public void testCreateThrowMessageDelegateExpression3() {
    ...
    // Act
    ThrowMessageDelegate actualCreateThrowMessageDelegateExpressionResult =
        defaultActivityBehaviorFactory.createThrowMessageDelegateExpression("Delegate Expression");

    // Assert
    verify(customFunctionProvider).addCustomFunctions(isA(ActivitiElContext.class));
    assertTrue(
        actualCreateThrowMessageDelegateExpressionResult instanceof ThrowMessageDelegateExpression);
  }
  ...
  public void testCreateThrowMessageDelegateExpression4() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doThrow(new ActivitiException("An error occurred"))
        .when(customFunctionProvider)
  ...
  public void testCreateThrowMessageDelegateExpression5() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doNothing().when(customFunctionProvider).addCustomFunctions(Mockito.<ActivitiElContext>any());
  ...
  public void testCreateThrowMessageDelegateExpression_thenCallsCreateExpression() {
    ...
    // Assert
    verify(expressionManager).createExpression("Delegate Expression");
    verify(expressionManager).setCustomFunctionProviders(isA(List.class));
    assertTrue(
        actualCreateThrowMessageDelegateExpressionResult instanceof ThrowMessageDelegateExpression);
  }
   ...
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createDefaultThrowMessageDelegate()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ThrowMessageDelegate DefaultActivityBehaviorFactory.createDefaultThrowMessageDelegate()"
  })
  public void testCreateDefaultThrowMessageDelegate_thenReturnDefaultThrowMessageJavaDelegate() {
    // Arrange, Act and Assert
    assertTrue(
        new DefaultActivityBehaviorFactory().createDefaultThrowMessageDelegate()
            instanceof DefaultThrowMessageJavaDelegate);
  }
  ...
  /**
   * Test {@link DefaultActivityBehaviorFactory#createMessagePayloadMappingProvider(Event,
   * MessageEventDefinition)}.
   *
   * <p>Method under test: {@link
   * DefaultActivityBehaviorFactory#createMessagePayloadMappingProvider(Event,
   * MessageEventDefinition)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  ...
  public void testCreateMessagePayloadMappingProvider() {
    ...
    // Act
    MessagePayloadMappingProvider actualCreateMessagePayloadMappingProviderResult =
        defaultActivityBehaviorFactory.createMessagePayloadMappingProvider(
            bpmnEvent, new MessageEventDefinition());
    Optional<Map<String, Object>> actualMessagePayload =
        actualCreateMessagePayloadMappingProviderResult.getMessagePayload(
            ExecutionEntityImpl.createWithEmptyRelationshipCollections());

    // Assert
    assertTrue(
        actualCreateMessagePayloadMappingProviderResult
            instanceof BpmnMessagePayloadMappingProvider);
    assertFalse(actualMessagePayload.isPresent());
  }

  /**
   * Test {@link DefaultActivityBehaviorFactory#checkClassDelegate(Map)}.
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#checkClassDelegate(Map)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional DefaultActivityBehaviorFactory.checkClassDelegate(Map)"})
   ...
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#checkDelegateExpression(Map)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional DefaultActivityBehaviorFactory.checkDelegateExpression(Map)"})
  public void testCheckDelegateExpression() {
    ...
    // Act and Assert
    assertFalse(
        defaultActivityBehaviorFactory.checkDelegateExpression(new HashMap<>()).isPresent());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link DefaultActivityBehaviorFactory#getAttributeValue(Map, String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional DefaultActivityBehaviorFactory.getAttributeValue(Map, String)"})
  public void testGetAttributeValue_givenArrayListAddExtensionAttribute_thenReturnNotPresent() {
    // Arrange
    DefaultActivityBehaviorFactory defaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional DefaultActivityBehaviorFactory.getAttributeValue(Map, String)"})
  public void testGetAttributeValue_givenArrayListAddExtensionAttribute_thenReturnNotPresent2() {
    // Arrange
    DefaultActivityBehaviorFactory defaultActivityBehaviorFactory =
        new DefaultActivityBehaviorFactory();
  ...
  public void testGetAttributeValue_whenHashMap_thenReturnNotPresent() {
    ...
    // Act and Assert
    assertFalse(
        defaultActivityBehaviorFactory.getAttributeValue(new HashMap<>(), "Name").isPresent());
  }
}
