...
public class DefaultActivityBehaviorFactoryDiffblueTest {
  ...
  public void testGetSkipExpressionFromServiceTask4() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
  ...
  public void testGetSkipExpressionFromServiceTask5() {
    // Arrange
    CustomFunctionProvider customFunctionProvider = mock(CustomFunctionProvider.class);
    doNothing().when(customFunctionProvider).addCustomFunctions(Mockito.<ActivitiElContext>any());
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link ScriptTask} (default constructor) ScriptFormat is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link
    ...
    assertNull(
        defaultActivityBehaviorFactory
            .createIntermediateCatchSignalEventActivityBehavior(
                intermediateCatchEvent, signalEventDefinition, new Signal("42", "Name"))
            .getMultiInstanceActivityBehavior());
  }
    ...
    assertNull(
        defaultActivityBehaviorFactory
            .createIntermediateThrowSignalEventActivityBehavior(
                throwEvent, signalEventDefinition, new Signal("42", "Name"))
            .getMultiInstanceActivityBehavior());
  }
    ...
    assertTrue(
        defaultActivityBehaviorFactory
            .createBoundarySignalEventActivityBehavior(
                boundaryEvent, signalEventDefinition, new Signal("42", "Name"), true)
            .isInterrupting());
  }
   ...
   *       ExtensionAttribute#ExtensionAttribute(String)} with name is {@code activiti}.
   * </ul>
   *
