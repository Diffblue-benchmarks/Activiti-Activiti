...
public class StringTypeDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link StringType#StringType(int)} with maxLength is one.
   *   <li>When {@code 42}.
  ...
  public void testIsAbleToStore_givenStringTypeWithMaxLengthIsOne_when42_thenReturnFalse() {
    // Arrange, Act and Assert
    assertFalse(new StringType(1).isAbleToStore("42"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean StringType.isAbleToStore(Object)"})
  public void testIsAbleToStore_givenStringTypeWithMaxLengthIsThree_when42_thenReturnTrue() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean StringType.isAbleToStore(Object)"})
  public void testIsAbleToStore_givenStringTypeWithMaxLengthIsThree_whenNull_thenReturnFalse() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean StringType.isAbleToStore(Object)"})
  public void testIsAbleToStore_givenStringTypeWithMaxLengthIsThree_whenNull_thenReturnTrue() {
    // Arrange, Act and Assert
