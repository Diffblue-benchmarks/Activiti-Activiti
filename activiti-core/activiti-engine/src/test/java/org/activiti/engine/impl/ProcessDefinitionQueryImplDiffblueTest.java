...
public class ProcessDefinitionQueryImplDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessDefinitionQueryImpl.checkVersion(Integer)"})
  public void testCheckVersion_whenOne_thenDoesNotThrow() {
    // Arrange, Act and Assert
    new ProcessDefinitionQueryImpl().checkVersion(1);
  }
  ...
  public void testEventSubscription_whenEventType_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ProcessDefinitionQueryImpl().eventSubscription("Event Type", null));
  }
  ...
  public void testCheckQueryOk_givenProcessDefinitionQueryImpl_thenDoesNotThrow() {
    // Arrange, Act and Assert
    new ProcessDefinitionQueryImpl().checkQueryOk();
  }
