...
public class CommandStatsDiffblueTest {
  ...
  public void testNewCommandStats_givenHashMapKeyIsFortyTwo_thenReturnDbSelectsSizeIsOne() {
    // Arrange
    HashMap<String, Long> dbSelects = new HashMap<>();
    dbSelects.put("Key", 42L);
    ...
    assertEquals(42L, dbSelects2.get("Key").longValue());
  }
