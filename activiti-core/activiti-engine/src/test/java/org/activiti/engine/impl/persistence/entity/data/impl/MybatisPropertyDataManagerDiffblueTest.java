...
public class MybatisPropertyDataManagerDiffblueTest {
   ...
   * <ul>
   *   <li>{@link
   *       MybatisPropertyDataManager#MybatisPropertyDataManager(ProcessEngineConfigurationImpl)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MybatisPropertyDataManager.<init>(ProcessEngineConfigurationImpl)",
    "Class MybatisPropertyDataManager.getManagedEntityClass()"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    Class<? extends PropertyEntity> actualManagedEntityClass =
        new MybatisPropertyDataManager(new JtaProcessEngineConfiguration()).getManagedEntityClass();
   ...
   *
   * <p>Method under test: {@link MybatisPropertyDataManager#create()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testCreate() {
    // Arrange and Act
    PropertyEntity actualCreateResult =
        new MybatisPropertyDataManager(new JtaProcessEngineConfiguration()).create();
