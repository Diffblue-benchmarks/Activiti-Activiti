...
public class AcquireAsyncJobsDueRunnableDiffblueTest {
  ...
  public void testNewAcquireAsyncJobsDueRunnable() {
    ...
    // Act
    AcquireAsyncJobsDueRunnable actualAcquireAsyncJobsDueRunnable = new AcquireAsyncJobsDueRunnable(asyncExecutor);

    // Assert
    AsyncExecutor asyncExecutor2 = actualAcquireAsyncJobsDueRunnable.asyncExecutor;
    ...
    assertFalse(actualAcquireAsyncJobsDueRunnable.isWaiting.get());
  ...
  public void testNewAcquireAsyncJobsDueRunnable2() {
    ...
    // Assert
    AsyncExecutor asyncExecutor = actualAcquireAsyncJobsDueRunnable.asyncExecutor;
