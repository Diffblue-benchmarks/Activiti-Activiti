...
public class DeleteIdentityLinkCmdDiffblueTest {
  ...
  public void testNewDeleteIdentityLinkCmd_whenAssignee() {
    ...
    assertThrows(
        ...
        () -> new DeleteIdentityLinkCmd("42", "42", "42", "assignee"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeleteIdentityLinkCmd.<init>(String, String, String, String)"})
  public void testNewDeleteIdentityLinkCmd_whenNull_thenReturnTypeIsAssignee() {
    // Arrange and Act
    DeleteIdentityLinkCmd actualDeleteIdentityLinkCmd =
        new DeleteIdentityLinkCmd("42", "42", null, "assignee");
  ...
  public void testNewDeleteIdentityLinkCmd_whenNull_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new DeleteIdentityLinkCmd("42", "42", "42", null));
  }
  ...
  public void testNewDeleteIdentityLinkCmd_whenNull_thenThrowActivitiIllegalArgumentException2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new DeleteIdentityLinkCmd(null, "42", "42", "assignee"));
  }
  ...
  public void testNewDeleteIdentityLinkCmd_whenOwner_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new DeleteIdentityLinkCmd("42", "42", "42", "owner"));
  }
  ...
  public void testValidateParams_whenAssignee_thenDoesNotThrow() {
    ...
    // Act and Assert
    deleteIdentityLinkCmd.validateParams("42", null, "assignee", "42");
  }
  ...
  public void testValidateParams_whenAssignee_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> deleteIdentityLinkCmd.validateParams("42", "42", "assignee", "42"));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeleteIdentityLinkCmd.validateParams(String, String, String, String)"})
  public void testValidateParams_whenAssignee_thenThrowActivitiIllegalArgumentException2() {
    // Arrange
    DeleteIdentityLinkCmd deleteIdentityLinkCmd =
        new DeleteIdentityLinkCmd("42", "42", "42", "Type");
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> deleteIdentityLinkCmd.validateParams("42", "42", "assignee", null));
  }
  ...
  public void testValidateParams_whenNull_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> deleteIdentityLinkCmd.validateParams("42", "42", null, "42"));
  }
  ...
  public void testValidateParams_whenOwner_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> deleteIdentityLinkCmd.validateParams("42", "42", "owner", "42"));
  }
  ...
  public void testValidateParams_whenType_thenDoesNotThrow() {
    ...
    // Act and Assert
    deleteIdentityLinkCmd.validateParams("42", "42", "Type", "42");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void DeleteIdentityLinkCmd.validateParams(String, String, String, String)"})
  public void testValidateParams_whenType_thenDoesNotThrow2() {
    // Arrange
    DeleteIdentityLinkCmd deleteIdentityLinkCmd =
        new DeleteIdentityLinkCmd("42", "42", "42", "Type");

    // Act and Assert
    deleteIdentityLinkCmd.validateParams(null, "42", "Type", "42");
  }
