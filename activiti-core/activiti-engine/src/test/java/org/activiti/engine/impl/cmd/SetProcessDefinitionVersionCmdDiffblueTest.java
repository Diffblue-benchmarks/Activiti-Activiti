...
public class SetProcessDefinitionVersionCmdDiffblueTest {
  ...
  public void testNewSetProcessDefinitionVersionCmd_when42_thenDoesNotThrow() {
  ...
  public void testNewSetProcessDefinitionVersionCmd_whenNull2() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class, () -> new SetProcessDefinitionVersionCmd(null, 1));
  }
