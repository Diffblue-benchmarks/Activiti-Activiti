...
public class JPAEntityMappingsDiffblueTest {
  @InjectMocks private JPAEntityMappings jPAEntityMappings;

  @Mock private Map<String, EntityMetaData> map;

  /**
   * Test {@link JPAEntityMappings#isJPAEntity(Object)}.
   *
   * <ul>
   *   <li>Given {@link JPAEntityMappings} (default constructor).
  ...
  public void testIsJPAEntity_givenJPAEntityMappings_whenNull_thenReturnFalse() {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean JPAEntityMappings.isJPAEntity(Object)"})
  public void testIsJPAEntity_givenJPAEntityMappings_whenNull_thenReturnFalse2() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean JPAEntityMappings.isJPAEntity(Object)"})
  public void testIsJPAEntity_givenJavaLangObject_whenNull_thenReturnTrue() {
    // Arrange
    EntityMetaData entityMetaData = new EntityMetaData();
    Class<Object> entityClass = Object.class;
    entityMetaData.setEntityClass(entityClass);
    entityMetaData.setJPAEntity(true);
    when(map.get(Mockito.<Object>any())).thenReturn(entityMetaData);

    // Act
    boolean actualIsJPAEntityResult = jPAEntityMappings.isJPAEntity(JSONObject.NULL);

    // Assert
    verify(map).get(isA(Object.class));
    assertTrue(actualIsJPAEntityResult);
  }
  ...
  public void testGetEntityMetaData_givenJPAEntityMappings_thenReturnEntityClassIsNull() {
    // Arrange
   ...
   * <ul>
   *   <li>Given {@code Object}.
   *   <li>Then return {@link EntityMetaData} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link JPAEntityMappings#getEntityMetaData(Class)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"EntityMetaData JPAEntityMappings.getEntityMetaData(Class)"})
  public void testGetEntityMetaData_givenJavaLangObject_thenReturnEntityMetaData() {
    // Arrange
    EntityMetaData entityMetaData = new EntityMetaData();
    Class<Object> entityClass = Object.class;
    entityMetaData.setEntityClass(entityClass);
    ...
    // Assert
    verify(map).get(isA(Object.class));
    assertSame(entityMetaData, actualEntityMetaData);
  }
  ...
  public void testGetJPAClassString_givenJavaLangObject_whenNull_thenReturnJavaLangObject() {
    // Arrange
    EntityMetaData entityMetaData = new EntityMetaData();
    Class<Object> entityClass = Object.class;
    entityMetaData.setEntityClass(entityClass);
    ...
    // Act
    String actualJPAClassString = jPAEntityMappings.getJPAClassString(JSONObject.NULL);

    // Assert
    verify(map).get(isA(Object.class));
    assertEquals("java.lang.Object", actualJPAClassString);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String JPAEntityMappings.getJPAClassString(Object)"})
  public void testGetJPAClassString_thenThrowActivitiIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String JPAEntityMappings.getJPAClassString(Object)"})
  public void testGetJPAClassString_whenNull_thenThrowActivitiIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
  ...
  public void testGetJPAIdString_givenJavaLangObject_whenNull_thenThrowActivitiException() {
    // Arrange
    EntityMetaData entityMetaData = new EntityMetaData();
    Class<Object> entityClass = Object.class;
    entityMetaData.setEntityClass(entityClass);
    ...
    // Act and Assert
    assertThrows(ActivitiException.class, () -> jPAEntityMappings.getJPAIdString(JSONObject.NULL));
    verify(map).get(isA(Object.class));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String JPAEntityMappings.getJPAIdString(Object)"})
  public void testGetJPAIdString_thenThrowActivitiIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
