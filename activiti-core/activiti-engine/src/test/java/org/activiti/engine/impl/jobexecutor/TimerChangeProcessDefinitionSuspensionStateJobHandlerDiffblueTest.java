...
public class TimerChangeProcessDefinitionSuspensionStateJobHandlerDiffblueTest {
   ...
   */
  @Test
  public void testCreateJobHandlerConfiguration() {
   ...
   */
  @Test
  public void testGetIncludeProcessInstances() throws JSONException {
    // Arrange
   ...
   */
  @Test
  public void testGetIncludeProcessInstances2() throws JSONException {
    // Arrange
    JSONObject jobHandlerCfgJson = mock(JSONObject.class);
