...
public class MailActivityBehaviorDiffblueTest {
  ...
  public void testCreateEmail_whenEmptyString_thenThrowActivitiException() {
    ...
    assertThrows(
        ActivitiException.class, () -> new MailActivityBehavior().createEmail("", "", false));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Email MailActivityBehavior.createEmail(String, String, boolean)"})
  public void testCreateEmail_whenEmptyString_thenThrowActivitiException3() {
    // Arrange, Act and Assert
    assertThrows(
  ...
  public void testCreateEmail_whenHtmlBodyHtmlContentBodyHtml_thenReturnHtmlEmail() {
    ...
    Email actualCreateEmailResult =
        new MailActivityBehavior()
            .createEmail(null, "<html><body>HTML Content</body></html>", true);
  ...
  public void testCreateEmail_whenHtmlBodyHtmlContentBodyHtml_thenThrowActivitiException() {
    ...
    assertThrows(
        ...
        () ->
            new MailActivityBehavior()
                .createEmail("", "<html><body>HTML Content</body></html>", true));
  }
  ...
  public void testCreateHtmlEmail_whenEmptyString_thenThrowActivitiException() {
    // Arrange, Act and Assert
    assertThrows(ActivitiException.class, () -> new MailActivityBehavior().createHtmlEmail("", ""));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"HtmlEmail MailActivityBehavior.createHtmlEmail(String, String)"})
  public void testCreateHtmlEmail_whenEmptyString_thenThrowActivitiException2() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiException.class,
        () ->
  ...
  public void testCreateHtmlEmail_whenNull_thenThrowActivitiException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiException.class, () -> new MailActivityBehavior().createHtmlEmail("", null));
  }
  ...
  public void testCreateTextOnlyEmail_whenNull_thenThrowActivitiException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiException.class, () -> new MailActivityBehavior().createTextOnlyEmail(null));
  }
  ...
  public void testCreateMultiPartEmail_whenNull_thenThrowActivitiException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiException.class, () -> new MailActivityBehavior().createMultiPartEmail(null));
  }
   ...
   *
   * <ul>
   *   <li>Given {@link EmailException#EmailException()}.
   *   <li>When {@link HtmlEmail} {@link HtmlEmail#addTo(String)} throw {@link
  ...
  public void testAddTo_givenEmailException_whenHtmlEmailAddToThrowEmailException()
   ...
   * <ul>
   *   <li>Given {@link EmailException#EmailException()}.
   *   <li>When {@link HtmlEmail} {@link HtmlEmail#setFrom(String)} throw {@link
   *       EmailException#EmailException()}.
   * </ul>
   *
  ...
  public void testSetFrom_givenEmailException_whenHtmlEmailSetFromThrowEmailException()
      throws EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();

    HtmlEmail email = mock(HtmlEmail.class);
    when(email.setFrom(Mockito.<String>any())).thenThrow(new EmailException());
   ...
   * <ul>
   *   <li>Given {@link EmailException#EmailException()}.
   *   <li>When {@link HtmlEmail} {@link HtmlEmail#addCc(String)} throw {@link
   *       EmailException#EmailException()}.
   * </ul>
   *
  ...
  public void testAddCc_givenEmailException_whenHtmlEmailAddCcThrowEmailException()
      throws EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
   ...
   * <ul>
   *   <li>Given {@link EmailException#EmailException()}.
   *   <li>When {@link HtmlEmail} {@link HtmlEmail#addBcc(String)} throw {@link
   *       EmailException#EmailException()}.
   * </ul>
   *
  ...
  public void testAddBcc_givenEmailException_whenHtmlEmailAddBccThrowEmailException()
      throws EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MailActivityBehavior.attach(Email, List, List)"})
  public void testAttach_givenNull_whenArrayListAddNull() throws EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
   ...
   *
   * <ul>
   *   <li>Then {@link MultiPartEmail} (default constructor) BoolHasAttachments.
   * </ul>
   *
   * <p>Method under test: {@link MailActivityBehavior#attach(Email, List, List)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MailActivityBehavior.attach(Email, List, List)"})
  public void testAttach_thenMultiPartEmailBoolHasAttachments() throws IOException, EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
    MultiPartEmail email = new MultiPartEmail();
    ArrayList<File> files = new ArrayList<>();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MailActivityBehavior.attach(Email, List, List)"})
  public void testAttach_whenHtmlEmail_thenHtmlEmailBoolHasAttachments() throws EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
    HtmlEmail email = new HtmlEmail();
   ...
   * <ul>
   *   <li>When {@code null}.
   *   <li>Then not {@link MultiPartEmail} (default constructor) BoolHasAttachments.
   * </ul>
   *
   * <p>Method under test: {@link MailActivityBehavior#attach(Email, List, List)}
   */
  ...
  public void testAttach_whenNull_thenNotMultiPartEmailBoolHasAttachments() throws EmailException {
    ...
    // Act
    mailActivityBehavior.attach(email, new ArrayList<>(), null);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MailActivityBehavior.attach(Email, List, List)"})
  public void testAttach_whenNull_thenNotMultiPartEmailBoolHasAttachments2() throws EmailException {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
    MultiPartEmail email = new MultiPartEmail();

    // Act
    mailActivityBehavior.attach(email, null, new ArrayList<>());
   ...
   *
   * <ul>
   *   <li>When {@code Mail Session Jndi}.
   *   <li>Then throw {@link ActivitiException}.
   * </ul>
   *
   * <p>Method under test: {@link MailActivityBehavior#setEmailSession(Email, String)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void MailActivityBehavior.setEmailSession(Email, String)"})
  public void testSetEmailSession_whenMailSessionJndi_thenThrowActivitiException() {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
  ...
  public void testHandleException_whenEmptyString_thenDoesNotThrow() {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
    DelegateExecution execution = mock(DelegateExecution.class);

    // Act and Assert
    mailActivityBehavior.handleException(execution, "Msg", new Exception(), true, "");
  }
  ...
  public void testHandleException_whenFalse_thenThrowActivitiException() {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
    DelegateExecution execution = mock(DelegateExecution.class);
  ...
  public void testHandleException_whenNull_thenDoesNotThrow() {
    // Arrange
    MailActivityBehavior mailActivityBehavior = new MailActivityBehavior();
    DelegateExecution execution = mock(DelegateExecution.class);

    // Act and Assert
    mailActivityBehavior.handleException(execution, "Msg", new Exception(), true, null);
  }
