...
public class AbstractVariableQueryImplDiffblueTest {
  ...
  public void testVariableValueEqualsWithNameValueLocalScope2() {
    ...
    assertThrows(
        ...
        () -> new ExecutionQueryImpl().variableValueEquals(null, "42", true));
  }
  ...
  public void testVariableValueEqualsWithNameValue_thenThrowActivitiIllegalArgumentException() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueEquals(null, "42"));
  }
  ...
  public void testVariableValueEqualsIgnoreCaseWithNameValue2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueEqualsIgnoreCase("Name", null));
  }
  ...
  public void testVariableValueEqualsIgnoreCaseWithNameValueLocalScope2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueEqualsIgnoreCase("Name", null, true));
  }
  ...
  public void testVariableValueNotEqualsIgnoreCaseWithNameValue2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueNotEqualsIgnoreCase("Name", null));
  }
  ...
  public void testVariableValueNotEqualsIgnoreCaseWithNameValueLocalScope2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueNotEqualsIgnoreCase("Name", null, true));
  }
  ...
  public void testVariableValueNotEqualsWithNameValue2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueNotEquals(null, "42"));
  }
  ...
  public void testVariableValueNotEqualsWithNameValueLocalScope2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueNotEquals(null, "42", true));
  }
  ...
  public void testVariableValueGreaterThanWithNameValueLocalScope_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueGreaterThan(null, "42", true));
  }
  ...
  public void testVariableValueGreaterThanWithNameValue_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueGreaterThan(null, "42"));
  }
  ...
  public void testVariableValueGreaterThanOrEqualWithNameValueLocalScope_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueGreaterThanOrEqual(null, "42", true));
  }
  ...
  public void testVariableValueGreaterThanOrEqualWithNameValue_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueGreaterThanOrEqual(null, "42"));
  }
  ...
  public void testVariableValueLessThanWithNameValueLocalScope_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueLessThan(null, "42", true));
  }
  ...
  public void testVariableValueLessThanWithNameValue_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueLessThan(null, "42"));
  }
  ...
  public void testVariableValueLessThanOrEqualWithNameValueLocalScope_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueLessThanOrEqual(null, "42", true));
  }
  ...
  public void testVariableValueLessThanOrEqualWithNameValue_when42() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueLessThanOrEqual(null, "42"));
  }
  ...
  public void testVariableValueLikeWithNameValueLocalScope3() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().variableValueLike(null, "42", true));
  }
  ...
  public void testVariableValueLikeWithNameValue_thenThrowActivitiIllegalArgumentException2() {
    ...
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new HistoricTaskInstanceQueryImpl().variableValueLike(null, "42"));
  }
  ...
  public void testAddVariable_when42_thenThrowActivitiIllegalArgumentException() {
    // Arrange, Act and Assert
    assertThrows(
        ActivitiIllegalArgumentException.class,
        () -> new ExecutionQueryImpl().addVariable(null, "42", QueryOperator.GREATER_THAN, true));
  }
