...
public class VariableEventHandlerDiffblueTest {
  ...
  public void testCreateData() {
    ...
    variableEvent.setVariableValue(true);
    ...
    assertEquals(Boolean.TRUE.toString(), actualCreateDataResult.get(Fields.VALUE));
    assertEquals(Boolean.TRUE.toString(), actualCreateDataResult.get(Fields.VALUE_JSON));
   ...
   *
   * <ul>
   *   <li>Given {@link BooleanType} (default constructor).
   *   <li>Then return {@link Fields#VALUE}.
   * </ul>
   *
   * <p>Method under test: {@link VariableEventHandler#createData(ActivitiVariableEvent)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Map VariableEventHandler.createData(ActivitiVariableEvent)"})
  public void testCreateData_givenBooleanType_thenReturnValue() {
    // Arrange
    VariableCreatedEventHandler variableCreatedEventHandler = new VariableCreatedEventHandler();
    ...
    // Assert
    assertEquals(3, actualCreateDataResult.size());
    assertTrue((Boolean) actualCreateDataResult.get(Fields.VALUE));
    assertTrue((Boolean) actualCreateDataResult.get(Fields.VALUE_BOOLEAN));
    assertEquals(
   ...
   *
   * <ul>
   *   <li>Given {@link StringType#StringType(int)} with maxLength is three.
   * </ul>
   *
   * <p>Method under test: {@link VariableEventHandler#createData(ActivitiVariableEvent)}
   */
   ...
   *
   * <ul>
   *   <li>Then return {@link Fields#VALUE} is {@link Boolean#TRUE} toString.
   * </ul>
   *
   * <p>Method under test: {@link VariableEventHandler#createData(ActivitiVariableEvent)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Map VariableEventHandler.createData(ActivitiVariableEvent)"})
  public void testCreateData_thenReturnValueIsTrueToString() {
    // Arrange
    VariableCreatedEventHandler variableCreatedEventHandler = new VariableCreatedEventHandler();
