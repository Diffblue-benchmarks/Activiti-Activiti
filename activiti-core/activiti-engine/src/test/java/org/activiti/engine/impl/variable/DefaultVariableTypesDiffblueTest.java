...
public class DefaultVariableTypesDiffblueTest {
   ...
   * <ul>
   *   <li>Given one.
   *   <li>When {@link ArrayList#ArrayList()} add one and {@link BigDecimalType} (default
   *       constructor).
   * </ul>
   *
  ...
  public void testSetTypesList_givenOne_whenArrayListAddOneAndBigDecimalType() {
    // Arrange
    DefaultVariableTypes defaultVariableTypes = new DefaultVariableTypes();
    ...
    typesList.add(1, new BigDecimalType());
