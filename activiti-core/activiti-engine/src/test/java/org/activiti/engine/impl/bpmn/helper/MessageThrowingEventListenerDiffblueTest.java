...
public class MessageThrowingEventListenerDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link MessageThrowingEventListener#onEvent(ActivitiEvent)}
   */
  @Test
  ...
  public void testOnEvent_givenJavaLangObject_thenDoesNotThrow() {
    ...
    messageThrowingEventListener.setEntityClass(entityClass);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MessageThrowingEventListener.<init>()",
    "boolean MessageThrowingEventListener.isFailOnException()",
    "void MessageThrowingEventListener.setMessageName(String)"
  })
  public void testGettersAndSetters() {
    // Arrange and Act
    MessageThrowingEventListener actualMessageThrowingEventListener =
        new MessageThrowingEventListener();
