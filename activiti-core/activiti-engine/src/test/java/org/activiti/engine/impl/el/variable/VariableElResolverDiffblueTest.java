...
public class VariableElResolverDiffblueTest {
  ...
  public void testCanResolve_whenSharedInstance_thenReturnFalse() {
    ...
    assertFalse(
        variableElResolver.canResolve("Property", NoExecutionVariableScope.getSharedInstance()));
  }
  ...
  public void testResolve_givenObjectMapperConvertValueReturnArrayList_thenReturnArrayList()
    ...
    when(objectMapper.convertValue(Mockito.<Object>any(), Mockito.<Class<List<Object>>>any()))
   ...
   *
   * <ul>
   *   <li>Given {@link VariableInstance} {@link VariableInstance#getValue()} return {@code null}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object VariableElResolver.resolve(String, VariableScope)"})
  public void testResolve_givenVariableInstanceGetValueReturnNull_thenReturnNull() {
    // Arrange
    VariableInstance variableInstance = mock(VariableInstance.class);
