...
public class EventSubscriptionsByProcInstTypeAndActivityMatcherDiffblueTest {
  /**
   * Test {@link
   * EventSubscriptionsByProcInstTypeAndActivityMatcher#isRetained(EventSubscriptionEntity, Object)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean EventSubscriptionsByProcInstTypeAndActivityMatcher.isRetained(EventSubscriptionEntity, Object)"
  })
  ...
  public void testIsRetainedWithEventSubscriptionEntityObject2() {
    ...
    EventSubscriptionEntity eventSubscriptionEntity = mock(EventSubscriptionEntity.class);
    when(eventSubscriptionEntity.getActivityId()).thenReturn("42");
    ...
    // Assert
    verify(eventSubscriptionEntity, atLeast(1)).getActivityId();
    verify(eventSubscriptionEntity, atLeast(1)).getEventType();
    verify(eventSubscriptionEntity, atLeast(1)).getProcessInstanceId();
    assertFalse(actualIsRetainedResult);
  }
  ...
  public void testIsRetainedWithEventSubscriptionEntityObject3() {
    ...
    EventSubscriptionEntity eventSubscriptionEntity = mock(EventSubscriptionEntity.class);
    when(eventSubscriptionEntity.getActivityId()).thenReturn(null);
    when(eventSubscriptionEntity.getProcessInstanceId()).thenReturn("Parameter");
    when(eventSubscriptionEntity.getEventType()).thenReturn("Parameter");
    ...
    // Assert
    verify(eventSubscriptionEntity).getActivityId();
    verify(eventSubscriptionEntity, atLeast(1)).getEventType();
    verify(eventSubscriptionEntity, atLeast(1)).getProcessInstanceId();
    assertFalse(actualIsRetainedResult);
  }
  ...
  public void testIsRetainedWithEventSubscriptionEntityObject_thenReturnTrue() {
    ...
    EventSubscriptionEntity eventSubscriptionEntity = mock(EventSubscriptionEntity.class);
    when(eventSubscriptionEntity.getActivityId()).thenReturn("Parameter");
    when(eventSubscriptionEntity.getProcessInstanceId()).thenReturn("Parameter");
    when(eventSubscriptionEntity.getEventType()).thenReturn("Parameter");
