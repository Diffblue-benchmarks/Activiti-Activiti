...
public class DelegateHelperDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FieldExtension DelegateHelper.getListenerField(DelegateExecution, String)"})
  public void testGetListenerField_givenActivitiListenerFieldExtensionsIsNull_thenReturnNull() {
    // Arrange
    ActivitiListener currentActivitiListener = new ActivitiListener();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FieldExtension DelegateHelper.getListenerField(DelegateExecution, String)"})
  public void testGetListenerField_givenFieldExtensionFieldNameIsExecution_thenReturnNull() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FieldExtension DelegateHelper.getListenerField(DelegateExecution, String)"})
  public void testGetListenerField_givenFieldExtensionFieldNameIsNull_thenReturnNull() {
    // Arrange
    FieldExtension fieldExtension = new FieldExtension();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FieldExtension DelegateHelper.getListenerField(DelegateExecution, String)"})
  public void testGetListenerField_thenCallsGetFieldExtensions() {
    // Arrange
    FieldExtension fieldExtension = mock(FieldExtension.class);
    doNothing().when(fieldExtension).setFieldName(Mockito.<String>any());
    fieldExtension.setFieldName("Execution");
    ...
    fieldExtension2.setFieldName("Field Extensions");

    ArrayList<FieldExtension> fieldExtensionList = new ArrayList<>();
    fieldExtensionList.add(fieldExtension2);
    ...
    verify(fieldExtension).setFieldName("Execution");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FieldExtension DelegateHelper.getListenerField(DelegateExecution, String)"})
  public void testGetListenerField_thenCallsGetFieldName() {
    // Arrange
    FieldExtension fieldExtension = mock(FieldExtension.class);
    when(fieldExtension.getFieldName()).thenReturn("Field Name");
    doNothing().when(fieldExtension).setFieldName(Mockito.<String>any());
  ...
  public void testGetFieldExpressionWithExecutionFieldName3() {
    ...
    // Act and Assert
    assertTrue(DelegateHelper.getFieldExpression(execution, "Field Name") instanceof FixedValue);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Expression DelegateHelper.getFieldExpression(DelegateExecution, String)"})
  public void testGetFieldExpressionWithExecutionFieldName_givenFieldExtensionFieldNameIsNull() {
    // Arrange
    FieldExtension fieldExtension = new FieldExtension();
    fieldExtension.setFieldName(null);
    fieldExtension.setExpression("not empty");
  ...
  public void testGetFieldExpressionWithExecutionFieldName_thenCallsGetFieldExtensions() {
    ...
    FieldExtension fieldExtension = new FieldExtension();
    fieldExtension.setFieldName("Field Extensions");
    fieldExtension.setExpression("not empty");
   ...
   *
   * <ul>
   *   <li>Then return ExpressionText is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link DelegateHelper#getFieldExpression(DelegateExecution, String)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Expression DelegateHelper.getFieldExpression(DelegateExecution, String)"})
  public void testGetFieldExpressionWithExecutionFieldName_thenReturnExpressionTextIs42() {
    // Arrange
    FieldExtension fieldExtension = mock(FieldExtension.class);
  ...
  public void testGetListenerFieldExpression_givenFieldExtensionFieldNameIsFieldName() {
    // Arrange
    FieldExtension fieldExtension = new FieldExtension();
    fieldExtension.setFieldName("Field Name");
    fieldExtension.setExpression(null);
    ...
    // Act and Assert
    assertTrue(
        DelegateHelper.getListenerFieldExpression(execution, "Field Name") instanceof FixedValue);
  }
  ...
  public void testGetListenerFieldExpression_givenFieldExtensionFieldNameIsNull_thenReturnNull() {
    // Arrange
    FieldExtension fieldExtension = new FieldExtension();
    fieldExtension.setFieldName(null);
    fieldExtension.setExpression("not empty");
  ...
  public void testGetListenerFieldExpression_thenReturnExpressionTextIs42() {
    // Arrange
    FieldExtension fieldExtension = mock(FieldExtension.class);
    when(fieldExtension.getExpression()).thenReturn("");
    when(fieldExtension.getStringValue()).thenReturn("42");
