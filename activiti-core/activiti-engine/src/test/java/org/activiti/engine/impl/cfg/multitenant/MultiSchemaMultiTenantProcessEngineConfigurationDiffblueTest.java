...
public class MultiSchemaMultiTenantProcessEngineConfigurationDiffblueTest {
  ...
  /**
   * Test {@link MultiSchemaMultiTenantProcessEngineConfiguration#MultiSchemaMultiTenantProcessEngineConfiguration(TenantInfoHolder)}.
   * <p>
   * Method under test: {@link MultiSchemaMultiTenantProcessEngineConfiguration#MultiSchemaMultiTenantProcessEngineConfiguration(TenantInfoHolder)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void MultiSchemaMultiTenantProcessEngineConfiguration.<init>(TenantInfoHolder)"})
  public void testNewMultiSchemaMultiTenantProcessEngineConfiguration() throws IOException {
    ...
    assertTrue(actualMultiSchemaMultiTenantProcessEngineConfiguration
        .getDynamicBpmnService() instanceof DynamicBpmnServiceImpl);
    assertTrue(
        actualMultiSchemaMultiTenantProcessEngineConfiguration.getHistoryService() instanceof HistoryServiceImpl);
    assertTrue(
        actualMultiSchemaMultiTenantProcessEngineConfiguration.getManagementService() instanceof ManagementServiceImpl);
    assertTrue(
        actualMultiSchemaMultiTenantProcessEngineConfiguration.getRepositoryService() instanceof RepositoryServiceImpl);
    assertTrue(
        actualMultiSchemaMultiTenantProcessEngineConfiguration.getRuntimeService() instanceof RuntimeServiceImpl);
    assertTrue(actualMultiSchemaMultiTenantProcessEngineConfiguration.getTaskService() instanceof TaskServiceImpl);
    assertTrue(actualMultiSchemaMultiTenantProcessEngineConfiguration.getDataSource() instanceof TenantAwareDataSource);
    assertTrue(actualMultiSchemaMultiTenantProcessEngineConfiguration.getIdGenerator() instanceof StrongUuidGenerator);
    assertTrue(actualMultiSchemaMultiTenantProcessEngineConfiguration
    ...
    assertTrue(
        actualMultiSchemaMultiTenantProcessEngineConfiguration.tenantInfoHolder instanceof DummyTenantInfoHolder);
    ...
    assertEquals(30, actualMultiSchemaMultiTenantProcessEngineConfiguration.getDefaultBpmnParseHandlers().size());
    assertEquals(300000,
  ...
  /**
   * Test {@link MultiSchemaMultiTenantProcessEngineConfiguration#registerTenant(String, DataSource)}.
   * <p>
   * Method under test: {@link MultiSchemaMultiTenantProcessEngineConfiguration#registerTenant(String, DataSource)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void MultiSchemaMultiTenantProcessEngineConfiguration.registerTenant(String, DataSource)"})
   ...
   * <p>
   * Method under test: {@link MultiSchemaMultiTenantProcessEngineConfiguration#initAsyncExecutor()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  /**
   * Test {@link MultiSchemaMultiTenantProcessEngineConfiguration#createTenantAsyncJobExecutor(String)}.
   * <ul>
   *   <li>Then calls {@link ExecutorPerTenantAsyncExecutor#addTenantAsyncExecutor(String, boolean)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MultiSchemaMultiTenantProcessEngineConfiguration#createTenantAsyncJobExecutor(String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void MultiSchemaMultiTenantProcessEngineConfiguration.createTenantAsyncJobExecutor(String)"})
  public void testCreateTenantAsyncJobExecutor_thenCallsAddTenantAsyncExecutor() {
    ...
    verify(tenantInfoHolder).addTenant(eq("Tenant Id"));
  }

  /**
   * Test {@link MultiSchemaMultiTenantProcessEngineConfiguration#createTransactionInterceptor()}.
   * <p>
   * Method under test: {@link MultiSchemaMultiTenantProcessEngineConfiguration#createTransactionInterceptor()}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link MultiSchemaMultiTenantProcessEngineConfiguration#postProcessEngineInitialisation()}
