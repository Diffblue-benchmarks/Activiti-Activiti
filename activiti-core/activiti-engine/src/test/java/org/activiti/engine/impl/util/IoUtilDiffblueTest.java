...
public class IoUtilDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void IoUtil.closeSilently(InputStream)"})
  public void testCloseSilentlyWithInputStream_whenByteArrayInputStreamWithAxaxaxaxBytesIsUtf8()
      throws UnsupportedEncodingException {
    // Arrange, Act and Assert
    IoUtil.closeSilently(new ByteArrayInputStream("AXAXAXAX".getBytes("UTF-8")));
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void IoUtil.closeSilently(InputStream)"})
  public void testCloseSilentlyWithInputStream_whenNull_thenDoesNotThrow() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void IoUtil.closeSilently(OutputStream)"})
  public void testCloseSilentlyWithOutputStream_whenByteArrayOutputStream_thenDoesNotThrow() {
    // Arrange, Act and Assert
    IoUtil.closeSilently(new ByteArrayOutputStream());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void IoUtil.closeSilently(OutputStream)"})
  public void testCloseSilentlyWithOutputStream_whenNull_thenDoesNotThrow() {
    // Arrange, Act and Assert
    IoUtil.closeSilently((OutputStream) null);
  }
}
