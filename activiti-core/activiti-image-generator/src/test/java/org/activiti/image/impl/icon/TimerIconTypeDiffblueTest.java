...
public class TimerIconTypeDiffblueTest {
   ...
   *
   * <p>Method under test: {@link TimerIconType#getWidth()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link TimerIconType#getHeight()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void TimerIconType.<init>()",
    "String TimerIconType.getAnchorValue()",
    "String TimerIconType.getDValue()",
    "String TimerIconType.getFillValue()",
    "String TimerIconType.getStrokeValue()",
    "String TimerIconType.getStrokeWidth()",
  ...
  public void testGettersAndSetters() {
    ...
    assertEquals(
        "M 10 0 C 4.4771525 0 0 4.4771525 0 10 C 0 15.522847 4.4771525 20 10 20 C 15.522847 20 20 15.522847 20"
            ...
            + " 8.2433585 10.5 8.0625 L 10.5 5 L 9.5 5 z ",
        actualDValue);
