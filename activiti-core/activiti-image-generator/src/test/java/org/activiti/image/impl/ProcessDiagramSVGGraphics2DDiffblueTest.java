...
public class ProcessDiagramSVGGraphics2DDiffblueTest {
   ...
   */
  @Test
  public void testNewProcessDiagramSVGGraphics2D() throws DOMException {
    // Arrange
  ...
  public void testSetRenderingHints() {
    ...
    // Act
    processDiagramSVGGraphics2D.setRenderingHints((Map) new HashMap<>());

    // Assert
    assertTrue(processDiagramSVGGraphics2D.getRenderingHints().isEmpty());
  }
}
