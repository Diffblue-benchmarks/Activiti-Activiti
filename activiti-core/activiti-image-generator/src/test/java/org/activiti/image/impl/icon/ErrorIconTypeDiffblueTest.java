...
public class ErrorIconTypeDiffblueTest {
   ...
   *
   * <p>Method under test: {@link ErrorIconType#getWidth()}
   */
  @Test
   ...
   *
   * <p>Method under test: {@link ErrorIconType#getHeight()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ErrorIconType.<init>()",
    "String ErrorIconType.getAnchorValue()",
    "String ErrorIconType.getDValue()",
    "String ErrorIconType.getFillValue()",
    "String ErrorIconType.getStrokeValue()",
    "String ErrorIconType.getStrokeWidth()",
  ...
  public void testGettersAndSetters() {
    ...
    // Assert
    assertEquals(
        " M21.820839 10.171502  L18.36734 23.58992  L12.541380000000002 13.281818999999999  L8.338651200000001"
    ...
    assertEquals(
        "fill:none;stroke-width:1.5;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:10",
