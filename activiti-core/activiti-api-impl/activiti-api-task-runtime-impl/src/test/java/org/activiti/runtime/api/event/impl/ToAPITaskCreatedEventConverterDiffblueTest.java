...
class ToAPITaskCreatedEventConverterDiffblueTest {
  ...
  void testFromWithActivitiEntityEvent_givenArrayListAddIdentityLinkEntityImpl() {
    ...
    assertTrue(getResult.getEntity() instanceof TaskImpl);
  ...
  @Test
  @DisplayName(
      "Test from(ActivitiEntityEvent) with 'ActivitiEntityEvent'; then calls getIdentityLinksForTask(String)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional ToAPITaskCreatedEventConverter.from(ActivitiEntityEvent)"})
  void testFromWithActivitiEntityEvent_thenCallsGetIdentityLinksForTask() {
    // Arrange
    TaskService taskService = mock(TaskService.class);
   ...
   *
   * <ul>
   *   <li>Then return {@link Optional#get()} Entity is {@link TaskImpl#TaskImpl()}.
   * </ul>
   *
   * <p>Method under test: {@link ToAPITaskCreatedEventConverter#from(ActivitiEntityEvent)}
   */
  @Test
  @DisplayName(
      "Test from(ActivitiEntityEvent) with 'ActivitiEntityEvent'; then return get() Entity is TaskImpl()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Optional ToAPITaskCreatedEventConverter.from(ActivitiEntityEvent)"})
  void testFromWithActivitiEntityEvent_thenReturnGetEntityIsTaskImpl() {
    // Arrange
    ...
    TaskCreatedEvent getResult = actualFromResult.get();
    org.activiti.api.task.model.Task entity = getResult.getEntity();
    assertTrue(entity instanceof TaskImpl);
    assertTrue(getResult instanceof TaskCreatedEventImpl);
    assertSame(taskImpl, entity);
  }
}
