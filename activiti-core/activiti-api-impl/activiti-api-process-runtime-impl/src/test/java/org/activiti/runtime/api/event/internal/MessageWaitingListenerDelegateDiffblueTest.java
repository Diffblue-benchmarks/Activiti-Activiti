...
class MessageWaitingListenerDelegateDiffblueTest {
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link MessageWaitingListenerDelegate#MessageWaitingListenerDelegate(List, ToMessageWaitingConverter)}
  ...
  @MethodsUnderTest({"void MessageWaitingListenerDelegate.<init>(List, ToMessageWaitingConverter)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageWaitingListenerDelegate#onEvent(ActivitiEvent)}
   */
  @Test
