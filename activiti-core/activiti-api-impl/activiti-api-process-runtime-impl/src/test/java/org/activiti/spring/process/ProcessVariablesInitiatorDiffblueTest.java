...
class ProcessVariablesInitiatorDiffblueTest {
  ...
  void testCalculateVariablesFromExtensionFile5() throws ActivitiException {
    ...
    stringVariableDefinitionMap.put("foo", new VariableDefinition("Type", "Value"));
  ...
  void testCalculateVariablesFromExtensionFile9() throws ActivitiException {
    ...
    HashMap<String, VariableDefinition> stringVariableDefinitionMap = new HashMap<>();
    stringVariableDefinitionMap.put("foo", variableDefinition);
  ...
  void testCalculateVariablesFromExtensionFile_givenHashMap42IsVariableDefinition() {
    ...
    stringVariableDefinitionMap.put("foo", new VariableDefinition());
  ...
  @Test
  @DisplayName(
      "Test calculateVariablesFromExtensionFile(ProcessDefinition, Map); given HashMap() 'foo' is VariableDefinition()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Map ProcessVariablesInitiator.calculateVariablesFromExtensionFile(ProcessDefinition, Map)"
  })
  void testCalculateVariablesFromExtensionFile_givenHashMapFooIsVariableDefinition() {
    // Arrange
    HashMap<String, VariableDefinition> stringVariableDefinitionMap = new HashMap<>();
    stringVariableDefinitionMap.put("foo", new VariableDefinition());
  ...
  @Test
  @DisplayName(
      "Test calculateOutputVariables(Map, ProcessDefinition, FlowElement); given HashMap() 'foo' is '42'; then return size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Map ProcessVariablesInitiator.calculateOutputVariables(Map, ProcessDefinition, FlowElement)"
  ...
  @Test
  @DisplayName(
      "Test calculateOutputVariables(Map, ProcessDefinition, FlowElement); given HashMap() 'foo' is VariableDefinition()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Map ProcessVariablesInitiator.calculateOutputVariables(Map, ProcessDefinition, FlowElement)"
  })
  void testCalculateOutputVariables_givenHashMapFooIsVariableDefinition() {
    // Arrange
    HashMap<String, VariableDefinition> stringVariableDefinitionMap = new HashMap<>();
    stringVariableDefinitionMap.put("foo", new VariableDefinition());
