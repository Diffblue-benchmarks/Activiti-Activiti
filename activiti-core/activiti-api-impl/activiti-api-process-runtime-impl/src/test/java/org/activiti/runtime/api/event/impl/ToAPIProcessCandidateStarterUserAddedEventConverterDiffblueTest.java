...
class ToAPIProcessCandidateStarterUserAddedEventConverterDiffblueTest {
  ...
  @Autowired
  private ToAPIProcessCandidateStarterUserAddedEventConverter
      toAPIProcessCandidateStarterUserAddedEventConverter;

  /**
   * Test {@link
   * ToAPIProcessCandidateStarterUserAddedEventConverter#ToAPIProcessCandidateStarterUserAddedEventConverter(APIProcessCandidateStarterUserConverter)}.
   *
  ...
  @Test
  @DisplayName(
      "Test new ToAPIProcessCandidateStarterUserAddedEventConverter(APIProcessCandidateStarterUserConverter)")
  ...
  void testNewToAPIProcessCandidateStarterUserAddedEventConverter() {
    // Arrange and Act
    ToAPIProcessCandidateStarterUserAddedEventConverter
        actualToAPIProcessCandidateStarterUserAddedEventConverter =
  ...
  /**
   * Test {@link ToAPIProcessCandidateStarterUserAddedEventConverter#from(ActivitiEntityEvent)} with
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "java.util.Optional ToAPIProcessCandidateStarterUserAddedEventConverter.from(ActivitiEntityEvent)"
  })
