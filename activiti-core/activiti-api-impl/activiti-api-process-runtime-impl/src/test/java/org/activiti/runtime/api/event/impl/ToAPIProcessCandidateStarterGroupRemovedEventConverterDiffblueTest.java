...
class ToAPIProcessCandidateStarterGroupRemovedEventConverterDiffblueTest {
  ...
  @Autowired
  private ToAPIProcessCandidateStarterGroupRemovedEventConverter
      toAPIProcessCandidateStarterGroupRemovedEventConverter;

  /**
   * Test {@link
   * ToAPIProcessCandidateStarterGroupRemovedEventConverter#ToAPIProcessCandidateStarterGroupRemovedEventConverter(APIProcessCandidateStarterGroupConverter)}.
   *
  ...
  @Test
  @DisplayName(
      "Test new ToAPIProcessCandidateStarterGroupRemovedEventConverter(APIProcessCandidateStarterGroupConverter)")
  ...
  void testNewToAPIProcessCandidateStarterGroupRemovedEventConverter() {
    // Arrange and Act
    ToAPIProcessCandidateStarterGroupRemovedEventConverter
        actualToAPIProcessCandidateStarterGroupRemovedEventConverter =
