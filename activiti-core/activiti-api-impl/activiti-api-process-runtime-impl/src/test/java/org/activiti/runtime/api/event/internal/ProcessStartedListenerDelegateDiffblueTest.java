...
class ProcessStartedListenerDelegateDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ToAPIProcessStartedEventConverter} {@link
   *       ToAPIProcessStartedEventConverter#from(ActivitiProcessStartedEvent)} return empty.
  ...
  @Test
  @DisplayName(
      "Test onEvent(ActivitiEvent); given ToAPIProcessStartedEventConverter from(ActivitiProcessStartedEvent) return empty; then calls from(ActivitiProcessStartedEvent)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessStartedListenerDelegate.onEvent(ActivitiEvent)"})
  void testOnEvent_givenToAPIProcessStartedEventConverterFromReturnEmpty_thenCallsFrom() {
    // Arrange
    ArrayList<ProcessRuntimeEventListener<ProcessStartedEvent>> listeners = new ArrayList<>();
    ...
    ToAPIProcessStartedEventConverter processInstanceStartedEventConverter =
        mock(ToAPIProcessStartedEventConverter.class);
    Optional<ProcessStartedEvent> emptyResult = Optional.empty();
    when(processInstanceStartedEventConverter.from(Mockito.<ActivitiProcessStartedEvent>any()))
