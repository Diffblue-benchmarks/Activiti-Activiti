...
class ProcessRuntimeImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then calls {@link ProcessInstanceQuery#count()}.
   * </ul>
   *
   * <p>Method under test: {@link ProcessRuntimeImpl#processInstances(Pageable)}
   */
  @Test
  @DisplayName("Test processInstances(Pageable) with 'pageable'; then calls count()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Page ProcessRuntimeImpl.processInstances(Pageable)"})
  void testProcessInstancesWithPageable_thenCallsCount() {
    // Arrange
    ProcessInstanceQuery processInstanceQuery = mock(ProcessInstanceQuery.class);
    when(processInstanceQuery.listPage(anyInt(), anyInt())).thenReturn(new ArrayList<>());
    when(processInstanceQuery.count()).thenReturn(3L);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Page ProcessRuntimeImpl.processInstances(Pageable)"})
  void testProcessInstancesWithPageable_thenCallsCount2() {
    // Arrange
    ProcessInstanceQuery processInstanceQuery = mock(ProcessInstanceQuery.class);
    when(processInstanceQuery.processDefinitionKeys(Mockito.<Set<String>>any()))
        .thenReturn(new ProcessInstanceQueryImpl());
  ...
  @Test
  @DisplayName(
      "Test suspend(SuspendProcessPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.activiti.api.process.model.ProcessInstance ProcessRuntimeImpl.suspend(SuspendProcessPayload)"
  })
  void testSuspend_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
  ...
  @Test
  @DisplayName(
      "Test resume(ResumeProcessPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.activiti.api.process.model.ProcessInstance ProcessRuntimeImpl.resume(ResumeProcessPayload)"
  })
  void testResume_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    when(runtimeService.createProcessInstanceQuery())
        .thenThrow(new ActivitiObjectNotFoundException(objectClass));
  ...
  @Test
  @DisplayName(
      "Test delete(DeleteProcessPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.activiti.api.process.model.ProcessInstance ProcessRuntimeImpl.delete(DeleteProcessPayload)"
  })
  void testDelete_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    when(runtimeService.createProcessInstanceQuery())
        .thenThrow(new ActivitiObjectNotFoundException(objectClass));
  ...
  @Test
  @DisplayName(
      "Test removeVariables(RemoveProcessVariablesPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessRuntimeImpl.removeVariables(RemoveProcessVariablesPayload)"})
  void testRemoveVariables_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    when(runtimeService.createProcessInstanceQuery())
        .thenThrow(new ActivitiObjectNotFoundException(objectClass));
  ...
  @Test
  @DisplayName(
      "Test setVariables(SetProcessVariablesPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessRuntimeImpl.setVariables(SetProcessVariablesPayload)"})
  void testSetVariables_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    when(runtimeService.createProcessInstanceQuery())
        .thenThrow(new ActivitiObjectNotFoundException(objectClass));
  ...
  @Test
  @DisplayName(
      "Test signal(SignalPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessRuntimeImpl.signal(SignalPayload)"})
  void testSignal_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    doThrow(new ActivitiObjectNotFoundException(objectClass))
        .when(processVariablesPayloadValidator)
  ...
  @Test
  @DisplayName(
      "Test update(UpdateProcessPayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.activiti.api.process.model.ProcessInstance ProcessRuntimeImpl.update(UpdateProcessPayload)"
  })
  void testUpdate_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    when(runtimeService.createProcessInstanceQuery())
        .thenThrow(new ActivitiObjectNotFoundException(objectClass));
  ...
  @Test
  @DisplayName(
      "Test receive(ReceiveMessagePayload); given 'java.lang.Object'; then throw ActivitiObjectNotFoundException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void ProcessRuntimeImpl.receive(ReceiveMessagePayload)"})
  void testReceive_givenJavaLangObject_thenThrowActivitiObjectNotFoundException() {
    // Arrange
    Class<Object> objectClass = Object.class;
    doThrow(new ActivitiObjectNotFoundException(objectClass))
        .when(processVariablesPayloadValidator)
