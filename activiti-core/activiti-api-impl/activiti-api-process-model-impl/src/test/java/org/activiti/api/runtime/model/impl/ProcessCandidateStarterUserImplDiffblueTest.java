...
class ProcessCandidateStarterUserImplDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return ProcessDefinitionId is {@code null}.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ProcessCandidateStarterUserImpl.<init>()",
  ...
  void testGettersAndSetters_thenReturnProcessDefinitionIdIsNull() {
    // Arrange and Act
    ProcessCandidateStarterUserImpl actualProcessCandidateStarterUserImpl =
        new ProcessCandidateStarterUserImpl();
  ...
  void testGettersAndSetters_when42_thenReturnProcessDefinitionIdIs42() {
    // Arrange and Act
    ProcessCandidateStarterUserImpl actualProcessCandidateStarterUserImpl =
        new ProcessCandidateStarterUserImpl("42", "42");
    String actualUserId = actualProcessCandidateStarterUserImpl.getUserId();
  ...
  /**
   * Test {@link ProcessCandidateStarterUserImpl#equals(Object)}, and {@link
   * ProcessCandidateStarterUserImpl#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean ProcessCandidateStarterUserImpl.equals(Object)",
    "int ProcessCandidateStarterUserImpl.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    ProcessCandidateStarterUserImpl processCandidateStarterUserImpl =
        new ProcessCandidateStarterUserImpl("42", "42");
    ProcessCandidateStarterUserImpl processCandidateStarterUserImpl2 =
        new ProcessCandidateStarterUserImpl("42", "42");

    // Act and Assert
    assertEquals(processCandidateStarterUserImpl, processCandidateStarterUserImpl2);
    assertEquals(
        processCandidateStarterUserImpl.hashCode(), processCandidateStarterUserImpl2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link ProcessCandidateStarterUserImpl#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    // Arrange
    ProcessCandidateStarterUserImpl processCandidateStarterUserImpl =
        new ProcessCandidateStarterUserImpl("Process Definition Id", "42");

    // Act and Assert
    assertNotEquals(
        processCandidateStarterUserImpl, new ProcessCandidateStarterUserImpl("42", "42"));
  }
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    // Arrange
    ProcessCandidateStarterUserImpl processCandidateStarterUserImpl =
        new ProcessCandidateStarterUserImpl("42", "User Id");
