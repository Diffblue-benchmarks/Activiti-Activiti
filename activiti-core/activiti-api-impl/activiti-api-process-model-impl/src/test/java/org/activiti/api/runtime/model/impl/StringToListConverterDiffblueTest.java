...
class StringToListConverterDiffblueTest {
  ...
  void testConvertWithString() {
    ...
    assertThrows(RuntimeException.class,
        () -> (new StringToListConverter(JsonMapper.builder().findAndAddModules().build())).convert("Source"));
  }
  ...
  void testConvertWithString2() {
    ...
    // Act and Assert
    assertThrows(RuntimeException.class,
        () -> (new StringToListConverter(builderResult.findAndAddModules().build())).convert("Source"));
  ...
  void testConvertWithString_givenObjectMapperReadValueReturnArrayList_thenReturnEmpty()
    ...
    // Act
    List<Object> actualConvertResult = stringToListConverter.convert("Source");
  ...
  void testConvertWithString_when42() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class,
        () -> (new StringToListConverter(JsonMapper.builder().findAndAddModules().build())).convert("42"));
  }
  ...
  void testConvertWithString_whenEmptyString() {
    // Arrange, Act and Assert
    assertThrows(RuntimeException.class,
        () -> (new StringToListConverter(JsonMapper.builder().findAndAddModules().build())).convert(""));
  }
}
