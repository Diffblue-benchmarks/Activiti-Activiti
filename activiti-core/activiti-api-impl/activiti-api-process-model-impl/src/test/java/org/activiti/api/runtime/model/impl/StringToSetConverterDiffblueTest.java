...
class StringToSetConverterDiffblueTest {
  ...
  @Autowired private StringToSetConverter stringToSetConverter;

  /**
   * Test {@link StringToSetConverter#convert(String)} with {@code String}.
   *
   * <p>Method under test: {@link StringToSetConverter#convert(String)}
   */
  @Test
  @DisplayName("Test convert(String) with 'String'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.util.Set StringToSetConverter.convert(String)"})
  void testConvertWithString() {
    ...
    // Act and Assert
    assertThrows(
        RuntimeException.class, () -> new StringToSetConverter(objectMapper).convert("Source"));
  }
  ...
  void testConvertWithString2() {
    ...
    // Act and Assert
    assertThrows(
        RuntimeException.class, () -> new StringToSetConverter(objectMapper).convert("42"));
  }
  ...
  void testConvertWithString_whenEmptyString() {
    ...
    // Act and Assert
    assertThrows(RuntimeException.class, () -> new StringToSetConverter(objectMapper).convert(""));
  }
