...
class MapToStringConverterDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test convert(Map) with 'Map'; given 'foo'; when HashMap() 'foo' is '42'; then return '{\"foo\":\"42\"}'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String MapToStringConverter.convert(Map)"})
  void testConvertWithMap_givenFoo_whenHashMapFooIs42_thenReturnFoo42() {
    ...
    // Act and Assert
    assertEquals("{\"foo\":\"42\"}", mapToStringConverter.convert(source));
  }
   ...
   */
  @Test
  @DisplayName("Test convert(Map) with 'Map'; then return '[\"java.util.HashMap\",{}]'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String MapToStringConverter.convert(Map)"})
  void testConvertWithMap_thenReturnJavaUtilHashMap() {
    // Arrange
    StdTypeResolverBuilder typer = mock(StdTypeResolverBuilder.class);
    PlaceholderForType baseType = new PlaceholderForType(1);
    TypeFactory typeFactory = TypeFactory.defaultInstance();
    ...
    verify(typer, atLeast(1))
        .buildTypeSerializer(isA(SerializationConfig.class), Mockito.<JavaType>any(), isNull());
    assertEquals("[\"java.util.HashMap\",{}]", actualConvertResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String MapToStringConverter.convert(Map)"})
  void testConvertWithMap_thenReturnJavaUtilHashMap2() {
    // Arrange
    StdTypeResolverBuilder typer = mock(StdTypeResolverBuilder.class);
    PlaceholderForType baseType = new PlaceholderForType(1);
    TypeFactory typeFactory = TypeFactory.defaultInstance();
   ...
   *
   * <ul>
   *   <li>Then return {@code {"Prop Name":"HashMap"}}.
   * </ul>
   *
   * <p>Method under test: {@link MapToStringConverter#convert(Map)}
   */
  @Test
  @DisplayName("Test convert(Map) with 'Map'; then return '{\"Prop Name\":\"java.util.HashMap\"}'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String MapToStringConverter.convert(Map)"})
  void testConvertWithMap_thenReturnPropNameJavaUtilHashMap() {
    // Arrange
    StdTypeResolverBuilder typer = mock(StdTypeResolverBuilder.class);
    PlaceholderForType baseType = new PlaceholderForType(1);
    TypeFactory typeFactory = TypeFactory.defaultInstance();
    ...
    AsPropertyTypeSerializer asPropertyTypeSerializer =
        new AsPropertyTypeSerializer(idRes, new Bogus(), "Prop Name");
    when(typer.buildTypeSerializer(
            Mockito.<SerializationConfig>any(),
            Mockito.<JavaType>any(),
            Mockito.<Collection<NamedType>>any()))
        .thenReturn(asPropertyTypeSerializer);
    ...
    verify(typer, atLeast(1))
        .buildTypeSerializer(isA(SerializationConfig.class), Mockito.<JavaType>any(), isNull());
    assertEquals("{\"Prop Name\":\"java.util.HashMap\"}", actualConvertResult);
  }
}
