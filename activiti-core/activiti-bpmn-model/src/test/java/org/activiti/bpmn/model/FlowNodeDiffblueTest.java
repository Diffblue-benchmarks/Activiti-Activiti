...
public class FlowNodeDiffblueTest {
  ...
  public void testSetValuesWithFlowNode_thenAdhocSubProcessIdIs42() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
    ...
    when(otherNode.getExecutionListeners()).thenReturn(activitiListenerList);
  ...
  public void testSetValuesWithFlowNode_whenAdhocSubProcess_thenNotAdhocSubProcessAsynchronous() {
    ...
    assertTrue(otherNode.getExecutionListeners().isEmpty());
