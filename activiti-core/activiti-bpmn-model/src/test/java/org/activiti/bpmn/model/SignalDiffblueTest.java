...
public class SignalDiffblueTest {
   ...
   *       ExtensionElements is {@link HashMap#HashMap()}.
   * </ul>
   *
   * <p>Method under test: {@link Signal#clone()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Signal Signal.clone()"})
  public void testClone_givenSignalWithIdIs42AndNameExtensionElementsIsHashMap() {
    // Arrange
    Signal signal = new Signal("42", "Name");
    signal.setExtensionElements(new HashMap<>());
    signal.setAttributes(null);
  ...
  public void testClone_givenSignalWithIdIs42AndNameExtensionElementsIsNull_thenReturnIdIs42() {
    ...
    signal.setAttributes(new HashMap<>());
