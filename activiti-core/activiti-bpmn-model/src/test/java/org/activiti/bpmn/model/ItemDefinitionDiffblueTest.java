...
public class ItemDefinitionDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ItemDefinition} (default constructor) ExtensionElements is {@link
   *       HashMap#HashMap()}.
   *   <li>Then return Id is {@code null}.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"ItemDefinition ItemDefinition.clone()"})
  public void testClone_givenItemDefinitionExtensionElementsIsHashMap_thenReturnIdIsNull() {
    // Arrange
    ItemDefinition itemDefinition = new ItemDefinition();
    itemDefinition.setExtensionElements(new HashMap<>());
    itemDefinition.setAttributes(null);
  ...
  public void testClone_givenItemDefinitionExtensionElementsIsNull_thenReturnIdIsNull() {
    ...
    itemDefinition.setAttributes(new HashMap<>());
