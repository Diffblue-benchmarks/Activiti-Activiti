...
public class ActivityDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_givenDataSpecCloneReturnDataSpec_thenCallsClone() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
    ...
    List<BoundaryEvent> boundaryEvents2 = otherActivity.getBoundaryEvents();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_givenDataSpecCloneReturnDataSpec_thenCallsClone2() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
   ...
   *
   * <ul>
   *   <li>Then {@link AdhocSubProcess} (default constructor) DataInputAssociations is {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link Activity#setValues(Activity)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenAdhocSubProcessDataInputAssociationsIsArrayList() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenAdhocSubProcessDataInputAssociationsIsArrayList2() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenAdhocSubProcessDataInputAssociationsIsArrayList3() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
   ...
   *
   * <ul>
   *   <li>Then {@link AdhocSubProcess} (default constructor) FailedJobRetryTimeCycleValue is {@code
   *       42}.
   * </ul>
   *
   * <p>Method under test: {@link Activity#setValues(Activity)}
  ...
  public void testSetValuesWithActivity_thenAdhocSubProcessFailedJobRetryTimeCycleValueIs42() {
    ...
    assertEquals(1, adhocSubProcess.getBoundaryEvents().size());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenAdhocSubProcessFailedJobRetryTimeCycleValueIs422() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenAdhocSubProcessFailedJobRetryTimeCycleValueIs423() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
   ...
   *
   * <ul>
   *   <li>Then {@link AdhocSubProcess} (default constructor) LoopCharacteristics Sequential.
   * </ul>
   *
   * <p>Method under test: {@link Activity#setValues(Activity)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenAdhocSubProcessLoopCharacteristicsSequential() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
    ...
    assertTrue(adhocSubProcess.getLoopCharacteristics().isSequential());
  ...
  public void testSetValuesWithActivity_thenCallsClone() {
    ...
    assertSame(dataAssociation4, dataOutputAssociations.get(0));
    assertSame(ioSpecification2, adhocSubProcess.getIoSpecification());
    assertSame(multiInstanceLoopCharacteristics2, loopCharacteristics);
  }
   ...
   *
   * <ul>
   *   <li>Then not {@link AdhocSubProcess} (default constructor) LoopCharacteristics Sequential.
   * </ul>
   *
   * <p>Method under test: {@link Activity#setValues(Activity)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_thenNotAdhocSubProcessLoopCharacteristicsSequential() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
    ...
    List<DataAssociation> dataOutputAssociations = adhocSubProcess.getDataOutputAssociations();
    assertEquals(1, dataOutputAssociations.size());
    assertFalse(adhocSubProcess.getLoopCharacteristics().isSequential());
    assertSame(dataAssociation2, dataInputAssociations.get(0));
    assertSame(dataAssociation4, dataOutputAssociations.get(0));
    assertSame(ioSpecification2, adhocSubProcess.getIoSpecification());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_whenAdhocSubProcessDataInputAssociationsIsNull() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Activity.setValues(Activity)"})
  public void testSetValuesWithActivity_whenAdhocSubProcessDataOutputAssociationsIsNull() {
    // Arrange
    AdhocSubProcess adhocSubProcess = new AdhocSubProcess();
