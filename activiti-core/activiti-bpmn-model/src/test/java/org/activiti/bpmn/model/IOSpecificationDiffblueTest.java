...
public class IOSpecificationDiffblueTest {
   ...
   *   <li>Then return DataInputs first Collection.
   * </ul>
   *
  ...
  public void testClone_givenDataSpecCollectionIsTrue_thenReturnDataInputsFirstCollection() {
    // Arrange
    ...
    DataSpec getResult2 = dataOutputs2.get(0);
    assertNull(getResult2.getId());
    assertNull(getResult.getItemSubjectRef());
    assertNull(getResult2.getItemSubjectRef());
    ...
    assertFalse(getResult2.isCollection());
   ...
   *
   * <ul>
   *   <li>Given {@link IOSpecification} (default constructor) DataInputs is {@code null}.
   *   <li>Then return DataInputs Empty.
   * </ul>
   *
   * <p>Method under test: {@link IOSpecification#clone()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"IOSpecification IOSpecification.clone()"})
  public void testClone_givenIOSpecificationDataInputsIsNull_thenReturnDataInputsEmpty() {
    // Arrange
    ArrayList<DataSpec> dataOutputs = new ArrayList<>();
    dataOutputs.add(new DataSpec());
   ...
   *   <li>Then return DataOutputs Empty.
   * </ul>
   *
   * <p>Method under test: {@link IOSpecification#clone()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"IOSpecification IOSpecification.clone()"})
  public void testClone_givenIOSpecificationDataOutputsIsNull_thenReturnDataOutputsEmpty() {
    // Arrange
    ArrayList<DataSpec> dataInputs = new ArrayList<>();
   ...
   *
   * <ul>
   *   <li>Then return not DataInputs first Collection.
   * </ul>
   *
   * <p>Method under test: {@link IOSpecification#clone()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"IOSpecification IOSpecification.clone()"})
  public void testClone_thenReturnNotDataInputsFirstCollection() {
    // Arrange
    ArrayList<DataSpec> dataInputs = new ArrayList<>();
    dataInputs.add(new DataSpec());
