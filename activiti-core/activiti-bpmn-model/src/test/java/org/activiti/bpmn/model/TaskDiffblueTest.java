...
public class TaskDiffblueTest {
  ...
  public void testClone_givenIOSpecificationDataOutputsIsNull() {
    ...
    assertEquals(1, ((Task) actualCloneResult).getDataInputAssociations().size());
    assertEquals(1, ((Task) actualCloneResult).getDataOutputAssociations().size());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"FlowElement Task.clone()"})
  public void testClone_givenTask_thenReturnIoSpecificationIsNull() {
    // Arrange and Act
  ...
  public void testSetValuesWithTask_givenIOSpecificationDataOutputsIsNull() {
    // Arrange
    Task task = new Task();
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link Task} (default constructor) DataInputAssociations is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_givenNull_whenTaskDataInputAssociationsIsNull() {
    // Arrange
    Task task = new Task();
   ...
   * <ul>
   *   <li>Given {@code null}.
   *   <li>When {@link Task} (default constructor) DataOutputAssociations is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_givenNull_whenTaskDataOutputAssociationsIsNull() {
    // Arrange
    Task task = new Task();
   ...
   *
   * <ul>
   *   <li>Then not {@link Task} (default constructor) LoopCharacteristics Sequential.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenNotTaskLoopCharacteristicsSequential() {
    // Arrange
    Task task = new Task();
   ...
   *
   * <ul>
   *   <li>Then {@link Task} (default constructor) DataInputAssociations is {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenTaskDataInputAssociationsIsArrayList() {
    // Arrange
    Task task = new Task();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenTaskDataInputAssociationsIsArrayList2() {
    // Arrange
    Task task = new Task();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenTaskDataInputAssociationsIsArrayList3() {
    // Arrange
    Task task = new Task();
   ...
   *
   * <ul>
   *   <li>Then {@link Task} (default constructor) FailedJobRetryTimeCycleValue is {@code 42}.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
   */
  ...
  public void testSetValuesWithTask_thenTaskFailedJobRetryTimeCycleValueIs42() {
    ...
    assertEquals(1, task.getBoundaryEvents().size());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenTaskFailedJobRetryTimeCycleValueIs422() {
    // Arrange
    Task task = new Task();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenTaskFailedJobRetryTimeCycleValueIs423() {
    // Arrange
    Task task = new Task();
   ...
   *
   * <ul>
   *   <li>Then {@link Task} (default constructor) LoopCharacteristics Sequential.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Task.setValues(Task)"})
  public void testSetValuesWithTask_thenTaskLoopCharacteristicsSequential() {
    // Arrange
    Task task = new Task();
    ...
    List<DataAssociation> dataOutputAssociations = task.getDataOutputAssociations();
    assertEquals(1, dataOutputAssociations.size());
    assertTrue(task.getLoopCharacteristics().isSequential());
    assertSame(dataAssociation2, dataInputAssociations.get(0));
    assertSame(dataAssociation4, dataOutputAssociations.get(0));
    assertSame(ioSpecification2, task.getIoSpecification());
  }
   ...
   *   <li>Then not {@link Task} (default constructor) hasMultiInstanceLoopCharacteristics.
   * </ul>
   *
   * <p>Method under test: {@link Task#setValues(Task)}
   */
