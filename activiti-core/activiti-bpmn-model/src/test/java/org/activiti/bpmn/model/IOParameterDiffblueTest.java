...
public class IOParameterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link IOParameter} (default constructor) ExtensionElements is {@link
   *       HashMap#HashMap()}.
   *   <li>Then return Id is {@code null}.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"IOParameter IOParameter.clone()"})
  public void testClone_givenIOParameterExtensionElementsIsHashMap_thenReturnIdIsNull() {
    // Arrange
    IOParameter ioParameter = new IOParameter();
    ioParameter.setExtensionElements(new HashMap<>());
    ioParameter.setAttributes(null);
  ...
  public void testClone_givenIOParameterExtensionElementsIsNull_thenReturnIdIsNull() {
    ...
    ioParameter.setAttributes(new HashMap<>());
