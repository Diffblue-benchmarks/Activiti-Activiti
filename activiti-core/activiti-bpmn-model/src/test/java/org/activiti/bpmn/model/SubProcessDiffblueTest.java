...
public class SubProcessDiffblueTest {
  ...
  public void testAddFlowElement() {
    ...
    FlowElementsContainer parentContainer2 = ((SubProcess) parentContainer).getParentContainer();
    assertTrue(parentContainer2 instanceof AdhocSubProcess);
    assertTrue(parentContainer instanceof SubProcess);
    assertNull(((AdhocSubProcess) parentContainer2).getParentContainer());
    assertNull(((AdhocSubProcess) parentContainer2).getSubProcess());
  }
  ...
  public void testAddFlowElement2() {
    ...
    assertTrue(parentContainer2.getFlowElementMap().isEmpty());
  }
   ...
   *
   * <ul>
   *   <li>Then {@link AdhocSubProcess} (default constructor) ParentContainer FlowElementMap size is
   *       one.
   * </ul>
   *
   * <p>Method under test: {@link SubProcess#addFlowElement(FlowElement)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SubProcess.addFlowElementToMap(FlowElement)"})
  public void testAddFlowElementToMap_givenNotEmpty_thenSubProcessFlowElementMapSizeIsOne() {
    // Arrange
    SubProcess subProcess = new SubProcess();
    HashMap<String, FlowElement> flowElementMap = new HashMap<>();
    subProcess.setFlowElementMap(flowElementMap);
   ...
   *
   * <ul>
   *   <li>Given {@link AdhocSubProcess} (default constructor) DataInputAssociations is {@code
   *       null}.
   * </ul>
   *
  ...
  public void testClone_givenAdhocSubProcessDataInputAssociationsIsNull() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given {@link AdhocSubProcess} (default constructor) DataOutputAssociations is {@code
   *       null}.
   * </ul>
   *
   * <p>Method under test: {@link SubProcess#clone()}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"SubProcess SubProcess.clone()"})
  public void testClone_givenAdhocSubProcessDataOutputAssociationsIsNull() {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SubProcess.setValues(SubProcess)"})
  public void testSetValuesWithSubProcess_givenAdhocSubProcess() {
    // Arrange
    SubProcess subProcess = new SubProcess();
   ...
   * <ul>
   *   <li>Given {@code true}.
   *   <li>When {@link SubProcess} (default constructor) ForCompensation is {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link SubProcess#setValues(SubProcess)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SubProcess.setValues(SubProcess)"})
  public void testSetValuesWithSubProcess_givenTrue_whenSubProcessForCompensationIsTrue() {
    // Arrange
    SubProcess subProcess = new SubProcess();
   ...
   *
   * <ul>
   *   <li>Then {@link SubProcess} (default constructor) DataInputAssociations Empty.
   * </ul>
   *
   * <p>Method under test: {@link SubProcess#setValues(SubProcess)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SubProcess.setValues(SubProcess)"})
  public void testSetValuesWithSubProcess_thenSubProcessDataInputAssociationsEmpty() {
    // Arrange
    SubProcess subProcess = new SubProcess();
    SubProcess otherElement = new SubProcess();
  ...
  public void testSetValuesWithSubProcess_thenSubProcessFlowElementsFirstBooleanDataObject() {
    ...
    SubProcess otherElement = new SubProcess();
    otherElement.addFlowElement(new BooleanDataObject());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SubProcess.setValues(SubProcess)"})
  public void testSetValuesWithSubProcess_whenAdhocSubProcessDataInputAssociationsIsNull() {
    // Arrange
    SubProcess subProcess = new SubProcess();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SubProcess.setValues(SubProcess)"})
  public void testSetValuesWithSubProcess_whenAdhocSubProcessDataOutputAssociationsIsNull() {
    // Arrange
    SubProcess subProcess = new SubProcess();
