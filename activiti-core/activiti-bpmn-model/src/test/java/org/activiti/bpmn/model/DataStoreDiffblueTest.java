...
public class DataStoreDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link DataStore} (default constructor) ExtensionElements is {@link
   *       HashMap#HashMap()}.
  ...
  public void testClone_givenDataStoreExtensionElementsIsHashMap_thenReturnIdIsNull() {
    // Arrange
    DataStore dataStore = new DataStore();
    dataStore.setExtensionElements(new HashMap<>());
  ...
  public void testClone_givenDataStoreExtensionElementsIsNull_thenReturnIdIsNull() {
    ...
    dataStore.setAttributes(new HashMap<>());
