...
public class WarningDiffblueTest {
   ...
   *
   * <p>Method under test: {@link Warning#Warning(String, String, int, int)}
   */
  @Test
   ...
   *   <li>Then return {@code Warning Message}.
   * </ul>
   *
   * <p>Method under test: {@link Warning#Warning(String, BaseElement)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Then return {@code Warning Message | line 2 | column 10}.
   * </ul>
   *
   * <p>Method under test: {@link Warning#toString()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testToString_thenReturnWarningMessageLine2Column10() {
    // Arrange
    Warning warning = new Warning("Warning Message", null, 2, 10);

    // Act and Assert
    assertEquals("Warning Message | line 2 | column 10", warning.toString());
  }
   ...
   *
   * <ul>
   *   <li>Then return {@code Warning Message | Local Name | line 2 | column 10}.
   * </ul>
   *
   * <p>Method under test: {@link Warning#toString()}
   */
  ...
  public void testToString_thenReturnWarningMessageLocalNameLine2Column10() {
    // Arrange
    Warning warning = new Warning("Warning Message", "Local Name", 2, 10);

    // Act and Assert
    assertEquals("Warning Message | Local Name | line 2 | column 10", warning.toString());
  }
}
