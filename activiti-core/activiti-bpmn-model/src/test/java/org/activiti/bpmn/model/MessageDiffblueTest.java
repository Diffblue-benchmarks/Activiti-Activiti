...
public class MessageDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Message Message.clone()"})
  public void testClone_givenHashMapKeyIsArrayList_thenReturnIdIs42() {
    // Arrange
    HashMap<String, List<ExtensionElement>> extensionElements = new HashMap<>();
    extensionElements.put("Key", new ArrayList<>());
   ...
   *       Name} and {@code Item Ref} ExtensionElements is {@link HashMap#HashMap()}.
   * </ul>
   *
   * <p>Method under test: {@link Message#clone()}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Message Message.clone()"})
  public void testClone_givenMessageWithIdIs42AndNameAndItemRefExtensionElementsIsHashMap() {
    // Arrange
    Message message = new Message("42", "Name", "Item Ref");
    message.setExtensionElements(new HashMap<>());
    message.setAttributes(null);
